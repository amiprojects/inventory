...
@WebServlet({ "/getcountry", "/addNewUOMtype", "/getUOMtype", "/getAllDepartments", "/getProductByDescription",
		...
		"/productSumaryJson", "/getVendorsByNameAndType", "/getVendorsByVendorTypeVendorAndName",
		"/getVendorsByVendorTypePurchaseAgentAndName", "/getCustomerByName", "/getCriticalStock",
		"/getSampleDesignCostSheetByDesignNumber", "/getProductDetailsByDesignNumberAndQuantity",
		...
		"/getSampleDesignCostSheetByDesignNumberForDuplicateCheck", "/getItmProductsForSampleByProductId",
		"/getJobPlanProductsByPlanId",
		"/getAllDesignNoFromSampleDesignCostSheetAndProductsByDesignNumberForDuplicateCheck",
		"/getProductDetailByDesignNumber", "/isExistProductDetailByDesignNumber",
		"/getPurchaseProductDetailsByLotNumber", "/getPaymentDetailsByJobAssignId",
		"/getAllVoucherDetailsByJobAssignId", "/getCustomerById", "/testcase", "/testcase1",
		"/getLastPurchaseProductDetailsByProductId", "/getProductByCategory", "/getAllCategoryByCategoryName",
		"/getProductByDesignNo", "/validity", "/updateSalesproduct", "/updateSalesEntry",
		"/getCurrentDebitNoteByCustomerId", "/getCurrentCreditNoteByVendorId",
		"/getPaymentDetails4ViaAgentBySalesEntryId", "/getAllVoucherDetails4ViaAgentBySalesEntryId",
		"/getCurrentCreditNote4ViaAgentByAgentId", "/getAllVoucherDetails4ViaAgentByPurchaseEntryId",
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			case "getItmProductsForSampleByProductId":
				resp.getWriter()
						.print(ejb.getItmProductsForSampleByProductId(Integer.parseInt(req.getParameter("id"))));
				break;

			case "getProductDetailByDesignNumber":
				resp.getWriter().print(ejb.getProductDetailByDesignNumber(req.getParameter("dNo")));
				break;

			case "isExistProductDetailByDesignNumber":
				JsonGeneratorFactory factoryIE = Json.createGeneratorFactory(null);
				JsonGenerator generatorIE = factoryIE.createGenerator(resp.getOutputStream());
				generatorIE.writeStartObject()
						.write("isExist", ejb.isExistProductDetailByDesignNumber(req.getParameter("dNo"))).writeEnd()
						.close();
				break;
			...
			case "getCustomerById":
				resp.getWriter().print(ejb.getCustomerEntryById(Integer.parseInt(req.getParameter("id"))));
				break;
			...
			case "getCurrentDebitNoteByCustomerId":
				JsonGeneratorFactory factoryCDN = Json.createGeneratorFactory(null);
				JsonGenerator generatorCDN = factoryCDN.createGenerator(resp.getOutputStream());
				voucherDetails = ejb
						.getLastVoucherDetailsByCustomerId(Integer.parseInt(req.getParameter("id")));
				generatorCDN.writeStartObject().write("vdId", voucherDetails.getId())
						.write("currentDebitNote", voucherDetails.getTotalDebitNote()).writeEnd();
				generatorCDN.close();
				break;

			case "getCurrentCreditNoteByVendorId":
				JsonGeneratorFactory factoryVDN = Json.createGeneratorFactory(null);
				JsonGenerator generatorVDN = factoryVDN.createGenerator(resp.getOutputStream());
				voucherDetails = ejb
						.getLastVoucherDetailsByVendorId(Integer.parseInt(req.getParameter("id")));
				if (voucherDetails != null) {
					generatorVDN.writeStartObject().write("currentCreditNote", voucherDetails.getTotalCreditNote())
							.writeEnd();
				} else {
					generatorVDN.writeStartObject().write("currentCreditNote", 0).writeEnd();
				}
				generatorVDN.close();
				break;

			case "getCurrentCreditNote4ViaAgentByAgentId":
				JsonGeneratorFactory factory4VA = Json.createGeneratorFactory(null);
				JsonGenerator generator4VA = factory4VA.createGenerator(resp.getOutputStream());
				generator4VA.writeStartObject()
						.write("currentCreditNote",
								ejb.getCurrentCreditNote4ViaAgentByAgentId(Integer.parseInt(req.getParameter("id"))))
						.writeEnd();
				generator4VA.close();
				break;
			...
			case "getPurchaseProductDetailsByProductCode":
				pw = resp.getWriter();
				pw.print(ejb.getPurchaseProductDetailsByProductCode(req.getParameter("code"),
						DateConverter.getDate(req.getParameter("date"))));
				break;
			...
			case "getProductDetailsByDesignNumberAndQuantity":
				...
				for (ProductsForDesignCostSheet pdcs : ejb
					...
					generator3.writeStartObject().write("ProductCode", pdcs.getProductDetail().getCode())
							...
							.write("ProductRemainingQty",
									pdcs.getProductDetail().isRaw()
											? pdcs.getProductDetail().getRawMaterialsStock().getRemainingQty()
											: pdcs.getProductDetail().getReadyGoodsStock().getRemainingQty())
							.write("ProductQtyForSample", pdcs.getQty()).write("ProductRateForSample", pdcs.getRate())
							.write("ProductAmountForSample", pdcs.getAmmount())
							.write("ProductForSampleId", pdcs.getId()).writeEnd();
				}
				generator3.writeEnd().close();
				break;

			case "getProductAndDesignDetailsAndJobPlanByJobPlanId":
				JsonGeneratorFactory factoryM = Json.createGeneratorFactory(null);
				JsonGenerator generatorM = factoryM.createGenerator(resp.getOutputStream());
				generatorM.writeStartArray();
				for (ProductsForDesignCostSheet pdcs : ejb.getJobPlanById(Integer.parseInt(req.getParameter("pId")))
						.getDesignCostSheet().getProductsForDesignCostSheets()) {
					if (ejb.getJobAssignmentProductDetailsByproductAndJobPlanId(pdcs.getProductDetail().getId(),
							Integer.parseInt(req.getParameter("pId"))) != null) {
						generatorM.writeStartObject().write("ProductCode", pdcs.getProductDetail().getCode())
								.write("ProductId", pdcs.getProductDetail().getId())
								.write("ProductDesc", pdcs.getProductDetail().getDescription())
								.write("ProductUOMid", pdcs.getProductDetail().getQtyUnit().getId())
								.write("ProductUOMName", pdcs.getProductDetail().getQtyUnit().getName())
								...
								.write("DesignNo", pdcs.getSampleDesignCostSheet().getDesignNumber())

								.write("JobAssignmentId",
										ejb.getJobAssignmentProductDetailsByproductAndJobPlanId(
												pdcs.getProductDetail().getId(),
												Integer.parseInt(req.getParameter("pId"))).getJobAssignmentDetails()
												.getId())
								.write("ProductTotalAmount",
										ejb.getJobAssignmentProductDetailsByproductAndJobPlanId(
												pdcs.getProductDetail().getId(),
												Integer.parseInt(req.getParameter("pId"))).getEstimatedCost())
								.write("japRemQty",
										ejb.getJobAssignmentProductDetailsByproductAndJobPlanId(
												pdcs.getProductDetail().getId(),
												Integer.parseInt(req.getParameter("pId"))).getRemaninQty())
								.write("japId",
										ejb.getJobAssignmentProductDetailsByproductAndJobPlanId(
												pdcs.getProductDetail().getId(),
					...
					if (!req.getParameter("japId").equals("0")) {
						if (ejb.getJobAssignmentJobDetailsByJobAssignmentProductIdAndJobsForDesignCostSheetId(
							...
							if (ejb.getJobAssignmentJobDetailsByJobAssignmentProductIdAndJobsForDesignCostSheetId(
								...
								if (ejb.getJobAssignmentProductById(Integer.parseInt(req.getParameter("japId")))
										.getRemaninQty() > 0
										&& ejb.getJobAssignmentJobDetailsByJobAssignmentProductIdAndJobsForDesignCostSheetId(
												Integer.parseInt(req.getParameter("japId")), jdcs.getId()) != null) {
									generatorJ.writeStartObject().write("JobId", jdcs.getId())
							...
							if (ejb.getJobAssignmentJobDetailsByPlanIdAndJobsForDesignCostSheetId(
									Integer.parseInt(req.getParameter("planId")), jdcs.getId()) != null) {
								generatorJ.writeStartObject().write("JobId", jdcs.getId())
										.write("JobName", jdcs.getJobTypes().getJobName())
										.write("JobRateOfSample", jdcs.getRate()).write("JobQtyOfSample", jdcs.getQty())
										.write("JobUOMOfSample", jdcs.getQtyUnit().getName())
										.write("JobAmountOfSample", jdcs.getAmmount()).write("Status", "Not Completed")

										.write("PresentRate",
												ejb.getJobAssignmentJobDetailsByPlanIdAndJobsForDesignCostSheetId(
														Integer.parseInt(req.getParameter("planId")), jdcs.getId())
														.getRate())
										.write("AssignQty", "NA").write("Amount", "NA").write("EstSubDate", "NA")
										.writeEnd();
							} else {
								generatorJ.writeStartObject().write("JobId", jdcs.getId())
										...
										.write("RemQty", jdcs.getQty()).write("PresentRate", "NA")
										.write("AssignQty", "NA").write("Amount", "NA").write("EstSubDate", "NA")
										.writeEnd();
							}
						}
			...
			case "getJobsForDesignCostSheetByProductSForSampleId":
				JsonGeneratorFactory factory4 = Json.createGeneratorFactory(null);
				JsonGenerator generator4 = factory4.createGenerator(resp.getOutputStream());
			...
			case "getOngoingJobAssignmentsByPlanId":
				JsonGeneratorFactory factoryJA = Json.createGeneratorFactory(null);
				JsonGenerator generatorJA = factoryJA.createGenerator(resp.getOutputStream());
				generatorJA.writeStartArray();
				for (JobAssignmentProducts jap : ejb
						.getOngoingJobAssignmentsByPlanId(Integer.parseInt(req.getParameter("pid")))
						.getJobAssignmentProducts()) {
					generatorJA.writeStartObject().write("japId", jap.getId()).writeEnd();
				}
				generatorJA.writeEnd().close();
				break;

			case "getPaymentDetailsByJobAssignId":
				JsonGeneratorFactory factoryPD = Json.createGeneratorFactory(null);
				JsonGenerator generatorPD = factoryPD.createGenerator(resp.getOutputStream());
				generatorPD.writeStartArray();
				for (PaymentDetails pd : ejb.getPaymentDetailsByJobAssignId(Integer.parseInt(req.getParameter("id")))) {
					String desc;
					String pType;
					...
					generatorPD.writeStartObject().write("paymentId", pd.getId()).write("paymentDescription", desc)
							.write("paymentAmount", pd.getPaidAmount())
							.write("paymentDate", pd.getPaymentDate().toString())
							.write("payTotalAmount", pd.getTotalAmount())
							.write("paymentStatus", pd.getPaymentStatus().getStatus()).write("paymentMethod", pType)
							.writeEnd();
				}
			...
			case "getPaymentDetails4ViaAgentBySalesEntryId":
				JsonGeneratorFactory factoryPD4VA = Json.createGeneratorFactory(null);
				JsonGenerator generatorPD4VA = factoryPD4VA.createGenerator(resp.getOutputStream());
				generatorPD4VA.writeStartArray();
				for (PaymentDetailsForViaAgents pd : ejb
						.getPaymentDetails4ViaAgentBySalesEntryId(Integer.parseInt(req.getParameter("id")))) {
					String desc;
					String pType;
					if (pd.getDescription() != null) {
						desc = pd.getDescription();
					...
					if (pd.getPaymentTypeId() != 0) {
						if (pd.getSalesReturnId() != 0) {
							pType = ejb.getPaymentTypeById(pd.getPaymentTypeId()).getType() + " (Return Value)";
						} else {
							pType = ejb.getPaymentTypeById(pd.getPaymentTypeId()).getType();
						}
					} else {
						pType = "NA";
					}
					generatorPD4VA.writeStartObject().write("paymentId", pd.getId()).write("paymentDescription", desc)
							.write("paymentAmount", pd.getPaidAmount())
							.write("paymentDate", pd.getPaymentDate().toString())
							.write("paymentStatus", ejb.getPaymentStatusById(pd.getPaymentStatusId()).getStatus())
			...
			case "getPaymentDetails4ViaAgentByPurchaseEntryId":
				JsonGeneratorFactory factoryPDPE = Json.createGeneratorFactory(null);
				JsonGenerator generatorPDPE = factoryPDPE.createGenerator(resp.getOutputStream());
				generatorPDPE.writeStartArray();
				for (PaymentDetailsForViaAgents pd : ejb
						.getPaymentDetails4ViaAgentByPurchaseEntryId(Integer.parseInt(req.getParameter("id")))) {
					String desc;
					String pType;
					if (pd.getDescription() != null) {
						desc = pd.getDescription();
					...
					generatorPDPE.writeStartObject().write("paymentId", pd.getId()).write("paymentDescription", desc)
							.write("paymentAmount", pd.getPaidAmount())
							.write("paymentDate", pd.getPaymentDate().toString())
							.write("paymentStatus", ejb.getPaymentStatusById(pd.getPaymentStatusId()).getStatus())
							.write("paymentMethod", pType).writeEnd();
			...
			case "getJobPlanProductsByPlanId":
				JsonGeneratorFactory factoryJPP = Json.createGeneratorFactory(null);
				JsonGenerator generatorJPP = factoryJPP.createGenerator(resp.getOutputStream());
				generatorJPP.writeStartArray();
				for (JobPlanProducts jpp : ejb.getJobPlanProductsByPlanId(Integer.parseInt(req.getParameter("pId")))) {
					generatorJPP.writeStartObject().write("jppQty", jpp.getQty())
							.write("jppRemQty", jpp.getRemainingQty()).writeEnd();
				}
			...
			case "getProductByDescription":
				pw = resp.getWriter();
				pw.print(ejb.getAllProductByProductDescription(req.getParameter("descriptionName")));
				break;
			...
			case "getPurchasebyPro":
				pw = resp.getWriter();
				pw.print(ejb.getInitialPurchase_Product_DetailsByProductIdAndCompany(
				...
				if (counter22 == 0) {
					...
					if (!req.getParameter("vendorExciseRegDate2").equals("")) {
						accountDetails2.setCstRegistrationDate(
								DateConverter.getDate(req.getParameter("vendorExciseRegDate2")));
					}
					...
					gen22.writeStartObject().write("result", "Agent added successfully")
							.write("vendorid", vendor2.getId()).write("vendorName", vendor2.getName())
							.write("vendorAddress", vendor2.getAddress()).write("vendorPh1", vendor2.getPh1())
							.write("vendorPh2", vendor2.getPh2()).writeEnd().close();
			...
			case "addUOMjson":
				...
				for (QtyUnit qut : ejb.getAllQtyUnit()) {
					if ((qut.getName().equalsIgnoreCase(req.getParameter("nameuom"))
							|| (qut.getAbbreviation().equalsIgnoreCase(req.getParameter("abbreviationuom"))))) {
						flagg = 1;
						break;
					}
				}
				if (flagg == 0) {
					...
					qtyUnit.setAbbreviation(req.getParameter("abbreviationuom").toUpperCase());
					qtyUnit.setDescription(req.getParameter("descriptionuom").toUpperCase());
					qtyUnit.setQtyUnitType(
							ejb.getQtyUnitTypeById(Integer.parseInt(req.getParameter("qtyUnitTypeIduom"))));
			...
			case "getSubByDepjson":
				resp.getWriter()
						.print(ejb.getAllSubDepartmentsByDepartmentId(Integer.parseInt(req.getParameter("id"))));
				break;

			case "getCatBySubjson":
				resp.getWriter().print(ejb.getAllCategoryBySubDepartmentId(Integer.parseInt(req.getParameter("id"))));
				break;

			case "getAllCategoryByCategoryName":
				resp.getWriter().print(ejb.getAllCategoryByCategoryName(req.getParameter("cat")));
				break;

			case "addJsonCountry":
				resp.setContentType("application/json");
				JsonGeneratorFactory jjss = Json.createGeneratorFactory(null);
				JsonGenerator genn = jjss.createGenerator(resp.getOutputStream());
				...
				if (flagg1 == 0) {
					...
					genn.writeStartObject().write("result", "Country added successfully").writeEnd().close();
				} else {
					genn.writeStartObject().write("result", "Duplicate Country Entry").writeEnd().close();
				}
			...
			case "addJsonState":
				...
				JsonGenerator stateG = stateA.createGenerator(resp.getOutputStream());

				List<State> sList = ejb.getAllStatesByCountryId(Integer.parseInt(req.getParameter("id")));
				int flag1 = 0;
				for (State st : sList) {
					if (st.getStateName().equals(req.getParameter("nameqaz").toUpperCase())) {
						flag1 = 1;
						break;
					}
				}
				if (flag1 == 0) {
					...
					stateG.writeStartObject().write("result", "State added successfully").writeEnd().close();
				} else {
					stateG.writeStartObject().write("result", "Duplicate State Entry").writeEnd().close();
				}
			...
			case "addJsonCity":
				...
				int flag2 = 0;
				for (City c : cities) {
					if (c.getCityName().equals(req.getParameter("namezxc").toUpperCase())) {
						flag2 = 1;
						break;
					}
				}
			...
			case "productSumaryJson":
				...
				companyInfo = ejb.getUserById((String) httpSession1.getAttribute("user")).getCompanyInfo();
				...
				if (flaggq == 0) {
					...
					if (req.getParameter("addini").equals("add")) {
						...
						purchaseProductDetails.setCompanyInfo(
								ejb.getUserById((String) httpSession1.getAttribute("user")).getCompanyInfo());
			...
			case "getCriticalStock":
				...
				for (ProductDetail pd : ejb.getAllProductDetail()) {
					if ((pd.isRaw() ? pd.getRawMaterialsStock().getRemainingQty()
							: pd.getReadyGoodsStock().getRemainingQty()) < 10) {
						generator.writeStartObject().write("productId", pd.getId()).write("productCode", pd.getCode())
								.write("productDescription", pd.getDescription()).writeEnd();
					}
				}
			...
			case "getSampleDesignCostSheetByDesignNumber":
				JsonGeneratorFactory factoryD = Json.createGeneratorFactory(null);
				JsonGenerator generatorD = factoryD.createGenerator(resp.getOutputStream());
				generatorD.writeStartArray();

				for (SampleDesignCostSheet sdcs : ejb.getSampleDesignCostSheetByDesignNumber(req.getParameter("dNo"))) {
					generatorD.writeStartObject().write("dId", sdcs.getId()).write("dNumber", sdcs.getDesignNumber())
			...
			case "getSampleDesignCostSheetByDesignNumberForDuplicateCheck":
				JsonGeneratorFactory factoryDC = Json.createGeneratorFactory(null);
				JsonGenerator generatorDC = factoryDC.createGenerator(resp.getOutputStream());
				generatorDC.writeStartArray();

				for (SampleDesignCostSheet sdcs : ejb
						.getSampleDesignCostSheetByDesignNumberForDuplicateCheck(req.getParameter("dNo"))) {
					generatorDC.writeStartObject().write("dId", sdcs.getId()).write("dNumber", sdcs.getDesignNumber())
							.write("dDEsc", sdcs.getDesignDescription()).writeEnd();
				}
			...
			case "getAllDesignNoFromSampleDesignCostSheetAndProductsByDesignNumberForDuplicateCheck":
				JsonGeneratorFactory factoryDN = Json.createGeneratorFactory(null);
				JsonGenerator generatorDN = factoryDN.createGenerator(resp.getOutputStream());
				generatorDN.writeStartArray();
				for (int i = 0; i < ejb
						.getAllDesignNoFromSampleDesignCostSheetAndProductsByDesignNumberForDuplicateCheck(
								req.getParameter("dNo"))
						.size(); i++) {
					generatorDN.writeStartObject()
							.write("dNumber",
			...
			case "getAllVoucherDetailsByJobAssignId":
				...
				if (ejb.getAllVoucherDetailsByJobAssignId(Integer.parseInt(req.getParameter("id"))).size() == 0) {
					voucherDetailSize = 0;
				} else {
					voucherDetailSize = ejb.getAllVoucherDetailsByJobAssignId(Integer.parseInt(req.getParameter("id")))
							.size();
				}
				jg.writeStartObject().write("voucherDetailSize", voucherDetailSize).writeEnd().close();
				break;

			case "getAllVoucherDetails4ViaAgentBySalesEntryId":
				JsonGeneratorFactory jgf4va = Json.createGeneratorFactory(null);
				JsonGenerator jg4va = jgf4va.createGenerator(resp.getOutputStream());
				int voucherDetSize = 0;
				if (ejb.getAllVoucherDetails4ViaAgentBySalesEntryId(Integer.parseInt(req.getParameter("id")))
						.size() == 0) {
					voucherDetSize = 0;
				} else {
					voucherDetSize = ejb
							.getAllVoucherDetails4ViaAgentBySalesEntryId(Integer.parseInt(req.getParameter("id")))
							.size();
				}
				jg4va.writeStartObject().write("voucherDetailSize", voucherDetSize).writeEnd().close();
				break;

			case "getAllVoucherDetails4ViaAgentByPurchaseEntryId":
				JsonGeneratorFactory jgf4vap = Json.createGeneratorFactory(null);
				JsonGenerator jg4vap = jgf4vap.createGenerator(resp.getOutputStream());
				int vouDetSize = 0;
				if (ejb.getAllVoucherDetails4ViaAgentByPurchaseEntryId(Integer.parseInt(req.getParameter("id")))
						.size() == 0) {
					vouDetSize = 0;
				} else {
					vouDetSize = ejb
							.getAllVoucherDetails4ViaAgentByPurchaseEntryId(Integer.parseInt(req.getParameter("id")))
							.size();
				}
				jg4vap.writeStartObject().write("voucherDetailSize", vouDetSize).writeEnd().close();
				break;

			case "getPurchaseProductDetailsByLotNumber":
				resp.getWriter().print(ejb.getPurchaseProductDetailsByLotNumber(req.getParameter("lotNo")));
				break;
			...
			case "getProductByDesignNo":
				resp.getWriter().print(ejb.getProductByDesignNo(req.getParameter("dNo")));
				break;

			case "getAllOngoingJobPlanByDesignNumber":
				JsonGeneratorFactory factoryJP = Json.createGeneratorFactory(null);
				JsonGenerator generatorJP = factoryJP.createGenerator(resp.getOutputStream());
				generatorJP.writeStartArray();
				for (JobPlan jp : ejb.getAllOngoingJobPlanByDesignNumber(Integer.parseInt(req.getParameter("dId")))) {
					generatorJP.writeStartObject().write("jpId", jp.getId())
							.write("jpDate", jp.getPlanDate().toString()).write("jpQty", jp.getQty()).writeEnd();
				}
				generatorJP.writeEnd().close();
				break;

			case "getAllJobPlanByDesignNumber":
				JsonGeneratorFactory factoryJP1 = Json.createGeneratorFactory(null);
				JsonGenerator generatorJP1 = factoryJP1.createGenerator(resp.getOutputStream());
				generatorJP1.writeStartArray();
				for (JobPlan jp : ejb.getAllJobPlanByDesignNumber(Integer.parseInt(req.getParameter("dId")))) {
			...
			case "getAllJobPlans":
				JsonGeneratorFactory factoryJP2 = Json.createGeneratorFactory(null);
				JsonGenerator generatorJP2 = factoryJP2.createGenerator(resp.getOutputStream());
			...
			case "getPlannedSampleDesignCostSheetByDesignNumber":
				JsonGeneratorFactory factoryDP = Json.createGeneratorFactory(null);
				JsonGenerator generatorDP = factoryDP.createGenerator(resp.getOutputStream());
				generatorDP.writeStartArray();

				for (SampleDesignCostSheet sdcs : ejb
						.getPlannedSampleDesignCostSheetByDesignNumber(req.getParameter("dNo"))) {
					generatorDP.writeStartObject().write("dId", sdcs.getId()).write("dNumber", sdcs.getDesignNumber())
							.write("dDEsc", sdcs.getDesignDescription()).writeEnd();
				}
			...
			case "updateSalesproduct":
				JsonGeneratorFactory factorySP = Json.createGeneratorFactory(null);
				JsonGenerator generatorSP = factorySP.createGenerator(resp.getOutputStream());
				try {
					SalesProductDetails spd = ejb.getSalesProductDetailsById(Integer.parseInt(req.getParameter("id")));

					purchaseProductDetails = spd.getPurchase_Product_Details();
					purchaseProductDetails.setRemaining_quantity(purchaseProductDetails.getRemaining_quantity()
							+ spd.getQuantity() - Float.parseFloat(req.getParameter("qty")));
					...
					if (purchaseProductDetails.getProductDetail().isRaw()) {
						...
						rawMaterialsStock.setRemainingQty(rawMaterialsStock.getRemainingQty() + spd.getQuantity()
								- Float.parseFloat(req.getParameter("qty")));
						ejb.updateRawMaterialStockDetail(rawMaterialsStock);
					} else {
						readyGoodsStock = ejb
								.getReadyGoodsStoctByProductId(purchaseProductDetails.getProductDetail().getId());
						readyGoodsStock.setRemainingQty(readyGoodsStock.getRemainingQty() + spd.getQuantity()
								- Float.parseFloat(req.getParameter("qty")));
						ejb.updateReadyGoodsStockDetail(readyGoodsStock);
					}

					SalesProductDetails salesProductDetails = ejb
							.getSalesProductDetailsById(Integer.parseInt(req.getParameter("id")));
					salesProductDetails.setQuantity(Float.parseFloat(req.getParameter("qty")));
					salesProductDetails.setSalesPrice(Float.parseFloat(req.getParameter("price")));
					ejb.updateSalesProductDetails(salesProductDetails);

					generatorSP.writeStartObject().write("error", false)
							.write("msg", "sales product details updated successfully").writeEnd().close();

				} catch (Exception e) {
					generatorSP.writeStartObject().write("error", true).write("msg", e.getMessage()).writeEnd().close();
					e.printStackTrace();
				}
			...
			case "updateSalesEntry":
				JsonGeneratorFactory factorySE = Json.createGeneratorFactory(null);
				JsonGenerator generatorSE = factorySE.createGenerator(resp.getOutputStream());
				try {
					SalesEntry salesEntry = ejb.getSalesEntryById(Integer.parseInt(req.getParameter("id")));
					salesEntry.setSubTotal(Float.parseFloat(req.getParameter("st")));
					salesEntry.setTaxAmount(Float.parseFloat(req.getParameter("taxAmount")));
					salesEntry.setTransportcCharge(Float.parseFloat(req.getParameter("trCharge")));
					...
					salesEntry.setTotalCost(Float.parseFloat(req.getParameter("gt")));
					...
					if (!req.getParameter("aId").equals("")) {
						...
						salesEntry.setAgentProfitValue(Float.parseFloat(req.getParameter("profitVal")));
						salesEntry.setAgentProfitTotal(Float.parseFloat(req.getParameter("profitValue")));
					} else {
					...
					salesEntry.setDiscountValue(Float.parseFloat(req.getParameter("discount")));
					ejb.updateSalesEntry(salesEntry);

					int paySize = ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).size();
					PaymentDetails paymentDetails = ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId())
							.get(paySize - 1);
					if (Float.parseFloat(req.getParameter("gt")) - paymentDetails.getPaidAmount() == 0) {
						paymentDetails.setPaymentStatus(ejb.getPaymentStatusByStatus("Full Paid"));

						if (ejb.getAllVoucherDetailsBySalesEntryId(salesEntry.getId()).size() > 0) {
							voucherDetails = ejb.getAllVoucherDetailsBySalesEntryId(salesEntry.getId()).get(0);
							voucherDetails.setValue(
									Float.parseFloat(req.getParameter("gt")) - paymentDetails.getPaidAmount());
						...
						if (ejb.getAllVoucherDetailsBySalesEntryId(salesEntry.getId()).size() > 0) {
							...
							voucherAssign = ejb.getVoucherAssignByCustomerId(salesEntry.getCustomer().getId());
					...
					if (salesEntry.getVendor() != null) {
						if (ejb.getVoucherAssignByVendorId(salesEntry.getVendor().getId()).size() == 0) {
							...
							voucherAssign = ejb.getVoucherAssignByVendorId(salesEntry.getVendor().getId()).get(0);
						}

						if (ejb.getAllVoucherDetails4ViaAgentBySalesEntryId(salesEntry.getId()).size() > 0) {
							voucherDetForViaAgent = ejb.getAllVoucherDetails4ViaAgentBySalesEntryId(salesEntry.getId())
									.get(0);
							voucherDetForViaAgent.setAgentId(salesEntry.getVendor().getId());
							voucherDetForViaAgent.setValue(Float.parseFloat(req.getParameter("profitValue")));
						...
						if (ejb.getAllVoucherDetails4ViaAgentBySalesEntryId(salesEntry.getId()).size() > 0) {
							voucherDetForViaAgent = ejb.getAllVoucherDetails4ViaAgentBySalesEntryId(salesEntry.getId())
									.get(0);
							ejb.deleteVoucherDetails4ViaAgentById(voucherDetForViaAgent.getId());
						}
					}

					for (SalesReturn sr : ejb.getSalesReturnBySalesEntryId(salesEntry.getId())) {
						float subTotal = 0;
						for (SalesProductReturnDetail sprd : sr.getSalesProductReturnDetail()) {
							subTotal = subTotal + (sprd.getQtyReturn() * sprd.getSalesProductDetails().getSalesPrice());
						}
						float discount = 0;
						if (sr.getSalesEntry().isFlatDiscount()) {
							discount = subTotal * sr.getSalesEntry().getDiscountValue()
									/ sr.getSalesEntry().getSubTotal();
						} else {
							discount = subTotal * sr.getSalesEntry().getDiscountValue() / 100;
						}
						float profit = 0;
						if (sr.getSalesEntry().isEfectiveProfit()) {
							if (sr.getSalesEntry().isFlatProfitAgent()) {
								profit = subTotal * sr.getSalesEntry().getAgentProfitValue()
										/ sr.getSalesEntry().getSubTotal();
							} else {
								profit = (subTotal - discount) * sr.getSalesEntry().getAgentProfitValue() / 100;
							}
						}
						float tax = 0;
						if (sr.getSalesEntry().getTax_Type_Group() != null) {
							tax = (subTotal - discount) * sr.getSalesEntry().getTax_Type_Group().getTotalTaxValue()
									/ 100;
						}
						...
						PaymentDetails payDetails = ejb.getPaymentDetailsBySalesReturnId(sr.getId()).get(0);
						payDetails.setPaidAmount(grandtotal);
						voucherDetails = ejb.getAllVoucherDetailsBySalesReturnId(sr.getId()).get(0);
						...
						if (salesEntry.getVendor() != null && salesEntry.isEfectiveProfit()) {
							if (ejb.getAllVoucherDetails4ViaAgentBySalesReturnId(sr.getId()).size() > 0) {
								voucherDetForViaAgent = ejb.getAllVoucherDetails4ViaAgentBySalesReturnId(sr.getId())
										.get(0);
								voucherDetForViaAgent.setAgentId(salesEntry.getVendor().getId());
								...
								voucherDetForViaAgent.setValue(sr.getRetAgentProfitTotal());
								voucherDetForViaAgent.setVoucherDate(sr.getReturnDate());
								voucherDetForViaAgent.setEntryDate(new Date());
								voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);
							}

							if (ejb.getPaymentDetails4ViaAgentBySalesReturnId(sr.getId()).size() > 0) {
								payDetForViaAgent = ejb.getPaymentDetails4ViaAgentBySalesReturnId(sr.getId()).get(0);
								...
								payDetForViaAgent.setPaymentDate(sr.getReturnDate());
								payDetForViaAgent.setEntryDate(new Date());
								payDetForViaAgent.setPaidAmount(sr.getRetAgentProfitTotal());
							...
							if (ejb.getPaymentDetails4ViaAgentBySalesReturnId(sr.getId()).size() > 0) {
								payDetForViaAgent = ejb.getPaymentDetails4ViaAgentBySalesReturnId(sr.getId()).get(0);
								ejb.deletePaymentDetails4ViaAgent(payDetForViaAgent.getId());
							}
						}
					}
					// new to check
					...
					VoucherAssign va = ejb.getVoucherAssignByCustomerId(salesEntry.getCustomer().getId());
					float totCr = 0;
					float totDb = 0;

					for (int ind = 0; ind < ejb.getAllVoucherDetailsByVoucherAssignId(va.getId()).size(); ind++) {
						voucherDetails = ejb.getAllVoucherDetailsByVoucherAssignId(va.getId()).get(ind);
					...
					int pSize = ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).size();
					if (pSize > 0) {
						float tot = ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).get(pSize - 1)
								.getTotalAmount();
						for (int ind = ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).size()
								- 1; ind > -1; ind--) {
							paymentDetails = ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).get(ind);
					...
					generatorSE.writeStartObject().write("error", false).write("msg", "Successful").writeEnd().close();
				} catch (Exception e) {
					generatorSE.writeStartObject().write("error", true).write("msg", "Error").writeEnd().close();
					e.printStackTrace();
				}
				break;
			...
			case "updatePurchaseEntry":
				...
				try {
					...
					// //////////////////////////////////////////////////
					purchase_Entry.setDiscountTotal(Float.parseFloat(req.getParameter("discountValue")));
					purchase_Entry.setTaxAmount(Float.parseFloat(req.getParameter("taxAmount")));
					purchase_Entry.setAgentProfitTotal(Float.parseFloat(req.getParameter("profitValue")));
					// //////////////////////////////////////////////////
					...
					// //////////////////////////////////////////////////
					int paySize = ejb.getPaymentDetailsByPurchaseEntryId(purchase_Entry.getId()).size();
					PaymentDetails paymentDetails = ejb.getPaymentDetailsByPurchaseEntryId(purchase_Entry.getId())
							.get(paySize - 1);
					if (Float.parseFloat(req.getParameter("gt")) - paymentDetails.getPaidAmount() == 0) {
						paymentDetails.setPaymentStatus(ejb.getPaymentStatusByStatus("Full Paid"));

						if (ejb.getAllVoucherDetailsByPurchaseEntryId(purchase_Entry.getId()).size() > 0) {
							voucherDetails = ejb.getAllVoucherDetailsByPurchaseEntryId(purchase_Entry.getId()).get(0);
							voucherDetails.setValue(
									Float.parseFloat(req.getParameter("gt")) - paymentDetails.getPaidAmount());
							ejb.updateVoucherDetails(voucherDetails);
						}
						...
						if (ejb.getAllVoucherDetailsByPurchaseEntryId(purchase_Entry.getId()).size() > 0) {
							...
							voucherAssign = ejb.getVoucherAssignByVendorId(purchase_Entry.getVendor().getId()).get(0);
							...
							voucherDetails.setValue(
									Float.parseFloat(req.getParameter("gt")) - paymentDetails.getPaidAmount());
							voucherDetails.setVoucherDate(purchase_Entry.getPurchase_date());
							voucherDetails.setUsers(ejb.getUserById((String) httpSession.getAttribute("user")));
							voucherDetails.setVoucherAssign(voucherAssign);
							ejb.setVoucherDetails(voucherDetails);
						}
					}
					System.out.println(voucherDetails.getPurchase_Entry().getId());
					System.out.println(purchase_Entry.getId());
					paymentDetails.setTotalAmount(Float.parseFloat(req.getParameter("gt")));
					// if (paymentDetails.getPaymentStatus().getStatus()
					// .equals("Full Paid")) {
					// paymentDetails.setTotalAmount(Float.parseFloat(req
					...
					if (purchase_Entry.getAgentId() != 0) {
						voucherDetForViaAgent = ejb
								.getAllVoucherDetails4ViaAgentByPurchaseEntryId(purchase_Entry.getId()).get(0);
						voucherDetForViaAgent.setValue(Float.parseFloat(req.getParameter("profitValue")));
						ejb.updateVoucherDetails4ViaAgent(voucherDetForViaAgent);
					}
					...
					for (PurchaseReturn pr : purchase_Entry.getPurchaseReturn()) {
						float subTotal = 0;
						for (PurchaseReturnProductDetails sprd : pr.getPurchaseReturnProductDetails()) {
							subTotal = subTotal + (sprd.getQtyReturn() * sprd.getPurchaseProductDetails().getCost());
						}
						float discount = 0;
						if (pr.getPurchaseEntry().isFlatDiscount()) {
							discount = subTotal * pr.getPurchaseEntry().getDiscountValue()
									/ pr.getPurchaseEntry().getSubTotal();
						} else {
							discount = subTotal * pr.getPurchaseEntry().getDiscountValue() / 100;
						}
						float profit = 0;
						if (pr.getPurchaseEntry().isEfectiveProfit()) {
							if (pr.getPurchaseEntry().isFlatProfitAgent()) {
								profit = subTotal * pr.getPurchaseEntry().getAgentProfitValue()
										/ pr.getPurchaseEntry().getSubTotal();
							} else {
								profit = (subTotal - discount) * pr.getPurchaseEntry().getAgentProfitValue() / 100;
							}
						}
						float tax = 0;
						if (pr.getPurchaseEntry().getTax_Type_Group() != null) {
							tax = (subTotal - discount) * pr.getPurchaseEntry().getTax_Type_Group().getTotalTaxValue()
									/ 100;
						}
						...
						PaymentDetails payDetails = ejb.getPaymentDetailsByPurchaseReturnId(pr.getId()).get(0);
						payDetails.setPaidAmount(grandtotal);
						voucherDetails = ejb.getAllVoucherDetailsByPurchaseReturnId(pr.getId()).get(0);
						voucherDetails.setValue(grandtotal);
						ejb.updateVoucherDetails(voucherDetails);

						ejb.updatePaymentDetails(payDetails);

						if (purchase_Entry.getAgentId() != 0 && purchase_Entry.isEfectiveProfit()) {
							voucherDetForViaAgent = ejb.getAllVoucherDetails4ViaAgentByPurchaseReturnId(pr.getId())
									.get(0);
							voucherDetForViaAgent.setValue(profit);
							ejb.updateVoucherDetails4ViaAgent(voucherDetForViaAgent);

							payDetForViaAgent = ejb.getPaymentDetails4ViaAgentByPurchaseReturnId(pr.getId()).get(0);
							payDetForViaAgent.setPaidAmount(profit);
							ejb.updatePaymentDetails4ViaAgent(payDetForViaAgent);
						}
					}
					...
					// correcting voucherdetails totalcreditnote for the
					// vendor
					for (VoucherAssign va : ejb.getVoucherAssignByVendorId(purchase_Entry.getVendor().getId())) {
						float totCr = 0;
						float totDb = 0;
					...
					int pSize = ejb.getPaymentDetailsByPurchaseEntryId(purchase_Entry.getId()).size();
					if (pSize > 0) {
						float tot = ejb.getPaymentDetailsByPurchaseEntryId(purchase_Entry.getId()).get(pSize - 1)
								.getTotalAmount();
						for (int ind = ejb.getPaymentDetailsByPurchaseEntryId(purchase_Entry.getId()).size()
								- 1; ind > -1; ind--) {
							paymentDetails = ejb.getPaymentDetailsByPurchaseEntryId(purchase_Entry.getId()).get(ind);
							paymentDetails.setTotalAmount(tot);
							tot = tot - paymentDetails.getPaidAmount();
							ejb.updatePaymentDetails(paymentDetails);
						}
			...
			case "setPurchaseProduct":
				...
				try {
					...
					if (purchaseProductDetails.getProductDetail().isRaw()) {
						...
						rawMaterialsStock.setProductDetail(ejb.getProductByProductCode(req.getParameter("proCode")));
						rawMaterialsStock.setRemainingQty(
								rawMaterialsStock.getRemainingQty() + Float.parseFloat(req.getParameter("qty")));
						ejb.updateRawMaterialStockDetail(rawMaterialsStock);
						rawMaterialsStock = null;
					} else {
						...
						readyGoodsStock.setRemainingQty(
								readyGoodsStock.getRemainingQty() + Float.parseFloat(req.getParameter("qty")));
						ejb.updateReadyGoodsStockDetail(readyGoodsStock);
						readyGoodsStock = null;
					}

					generator6.writeStartObject().write("error", false).write("msg", "Data updated suucessfully")
							.write("ppid", purchaseProductDetails.getId()).writeEnd().close();
			...
			case "getLastPurchaseProductDetailsByProductId":
				resp.getWriter()
						.print(ejb.getLastPurchaseProductDetailsByProductId(Integer.parseInt(req.getParameter("pId"))));
				break;
			...
			case "validity":
				...
				if (req.getParameter("uniqueNm").equals(ejb.getAllUniqueName().get(0).getUniqueNm())) {
					if (f == 0) {
						LocalDateTime dt = LocalDateTime.ofInstant(stocts.get(0).getEndDate().toInstant(),
								ZoneId.systemDefault());
						LocalDateTime endTime = dt.plusMonths(month);
						stoct = new Stoct();
						stoct.setStartDate(Date.from(dt.toInstant(ZoneOffset.ofHoursMinutes(5, 30))));
						stoct.setEndDate(Date.from(endTime.toInstant(ZoneOffset.ofHoursMinutes(5, 30))));
						stoct.setStockNumber(key);
						ejb.setStoct(stoct);
						JsonGeneratorFactory fact = Json.createGeneratorFactory(null);
						JsonGenerator gena = fact.createGenerator(resp.getOutputStream());
						gena.writeStartObject().write("msg", "Successfull!").writeEnd().close();
					} else {
						JsonGeneratorFactory fact = Json.createGeneratorFactory(null);
						JsonGenerator gena = fact.createGenerator(resp.getOutputStream());
						gena.writeStartObject().write("msg", "Unsuccessfull!").writeEnd().close();
					}
				} else {
					JsonGeneratorFactory fact = Json.createGeneratorFactory(null);
					JsonGenerator gena = fact.createGenerator(resp.getOutputStream());
					gena.writeStartObject().write("msg", "Please try again!.").writeEnd().close();
				}
				break;

			// streaming api
			case "testcase":
				JsonGeneratorFactory factory7 = Json.createGeneratorFactory(null);
				JsonGenerator jsongen = factory7.createGenerator(resp.getOutputStream());
