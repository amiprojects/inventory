...
@WebServlet({ "/getcountry", "/addNewUOMtype", "/getUOMtype", "/getAllDepartments", "/getProductByDescription",
		...
		"/getDesignImageBySampleJobId", "/getPlanNumbersById", "/updatePurchaseEntry", "/updatePurchaseproduct","/setPurchaseProduct" })
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			case "getAllOngoingJobPlanByDesignNumber":
				...
				for (JobPlan jp : ejb.getAllOngoingJobPlanByDesignNumber(req.getParameter("dNo"))) {
