...
@WebServlet({ "/logout", "/addTax", "/addTaxGroup", "/editTax", "/deleteTax", "/editTaxGroup", "/deleteTaxGroup",
		...
		"/jobAssignmentForParticularDesignNumber", "/jobAssignmentForOngoingJobs", "/sampleJobSearchAll",
		"/sampleJobSearchByDesignNo", "/sampleJobSearchByDesignerName", "/sampleJobCostSheetView", "/jobSearchByPlanNo",
		"/purchaseEdit", "/jobReceiveFromSearch", "/setItems", "/updateItems",
		"/completePlanAndProductSumaryProduction", "/purchaseProductionView", "/purchaseProductionSearchAll",
		"/purchaseProductionSearchByDate", "/purchaseProductionSearchByPurchaseChallanNo",
		"/purchaseProductionSearchByProductCode", "/jobSearchAllForPayment", "/jobAssignSearchByDateForPayment",
		"/jobSearchByJobChallanNoForPayment", "/jobSearchByProductCodeForPayment", "/jobSearchByJobberNameForPayment",
		"/jobSearchByPlanNoForPayment", "/jobPayment", "/purchasePayment", "/salesPayment", "/creditNoteByVendorName",
		"/creditNoteByAgentName", "/creditNoteByJobber", "/debitNoteByCustomer", "/testServManage",
		"/salesReturnSearchAll", "/salesReturnView", "/salesRerturnSearchByDate", "/salesReturnSearchByChallanNo",
		"/salesReturnSearchByRefChallanNo", "/salesReturnSearchByCustomerName", "/salesReturnSearchByAgentName",
		"/salesReturnSearchByProductCode", "/salesEdit", "/purchaseReturnSearchAll", "/purchaseReturnView",
		"/purchaseReturnSearchByDate", "/purchaseRetSearchByRefChallanNo", "/purchaseRetSearchByProductCode",
		"/purchaseRetSearchByVendorName", "/purchaseRetSearchByAgentName", "/purchaseRetSearchByChallanNo",
		"/salesSearchAllForAgent", "/salesSearchByDateForAgent", "/salesSearchBySalesChallanNoForAgent",
		"/salesSearchByAgentNameForAgent", "/salesSearchByCustomerNameForAgent", "/salesSearchByProductCodeForAgent",
		"/salesAgentPayment", "/creditNoteBySalesAgentName", "/purchaseSearchAllForViaPurchaseAgent",
		"/purchaseSearchByDateForViaPurchaseAgent", "/purchaseSearchByPurchaseChallanNoForViaPurchaseAgent",
		"/purchaseSearchByProductCodeForViaPurchaseAgent", "/purchaseSearchByVendorNameForViaPurchaseAgent",
		"/purchaseSearchByAgentNameForViaPurchaseAgent", "/purchaseSearchByViaAgentName",
		"/purchaseRetSearchByViaAgentNamet", "/purchaseAgentPayment", "/creditNoteByViaPurchaseAgentName" })
public class Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (httpSession.getAttribute("user") == null) {
			if (!(url.equals("forgotPassUserCheck") || url.equals("forgotPassVarify") || url.equals("resetPass"))) {
				// System.exit(0);
				page = "index.jsp";
			...
			if (!GetMacId.getSerialNumberOfKaanishExternalHDD(
				...
				try {
					...
					case "updateCompanyInfo":
						...
						companyInfo.setCompname(req.getParameter("name").toUpperCase());
						...
						companyInfo.setAddr(req.getParameter("adress").toUpperCase());
						companyInfo.setCity(req.getParameter("city").toUpperCase());
						companyInfo.setCountry1(req.getParameter("country1").toUpperCase());
						companyInfo.setState(req.getParameter("state").toUpperCase());
						companyInfo.setVatno(req.getParameter("vatno").toUpperCase());
						companyInfo.setCstno(req.getParameter("cstno").toUpperCase());
						companyInfo.setTinno(req.getParameter("tinno").toUpperCase());
						...
						companyInfo.setBarcodeHeader(req.getParameter("barcodeHeader").toUpperCase());
					...
					case "productSumary":
						...
						if (flagg == 0) {
							...
							productDetail.setRaw(Boolean.parseBoolean(req.getParameter("isRaw")));
							productDetail.setSaleble(Boolean.parseBoolean(req.getParameter("isSalebi")));
							productDetail
									.setCategory(ejb.getCategoryById(Integer.parseInt(req.getParameter("catagoryId"))));
							...
							if (req.getParameter("addini").equals("add")) {
								...
								purchaseProductDetails
										.setRemaining_quantity(Float.parseFloat(req.getParameter("qty1")));
								...
								purchaseProductDetails.setCompanyInfo(
								...
								if (productDetail.isRaw()) {
									...
									rawMaterialsStock.setRemainingQty(rawMaterialsStock.getRemainingQty()
									...
									readyGoodsStock = ejb.getReadyGoodStoctByProductAndCompanyId(productDetail.getId(),
											companyInfo.getId());
									readyGoodsStock.setRemainingQty(readyGoodsStock.getRemainingQty()
											+ Float.parseFloat(req.getParameter("qty1")));
					...
					case "completePlanAndProductSumaryProduction":
						...
						for (Purchase_Entry pe : purEntry) {
							if (pe.getChallanNumber().equals(req.getParameter("challanNumber"))) {
								chP = 1;
								break;
							}
						}
						if (chP == 0) {
							if (req.getParameter("isExistProdInSample").equals("yes")) {
								productDetail = ejb.getProductDetailByDesignNumber(req.getParameter("upc"));
							} else {
								productDetail = new ProductDetail();
								productDetail.setCode(req.getParameter("productCode").toUpperCase());
								productDetail.setDescription(req.getParameter("description").toUpperCase());
								...
								productDetail.setCategory(
										ejb.getCategoryById(Integer.parseInt(req.getParameter("catagoryId"))));
								productDetail.setActive(true);
								ejb.setProductDetail(productDetail);
							...
							purchaseEntry.setVendor(ejb.getVendorByVendorTypeAndName("Vendor", "Production Vendor"));
							...
							purchaseEntry.setCompanyInfo(
									ejb.getUserById((String) httpSession.getAttribute("user")).getCompanyInfo());
							purchaseEntry.setRoundOf(0);
							ejb.setPurchaseEntry(purchaseEntry);

							if (ejb.getVoucherAssignByVendorId(
									ejb.getVendorByVendorTypeAndName("Vendor", "Production Vendor").getId())
									.size() == 0) {
								voucherAssign = new VoucherAssign();
								vendor = ejb.getVendorByVendorTypeAndName("Vendor", "Production Vendor");
							...
							paymentDetails.setPaymentType(ejb.getPaymentTypeByType("Cash"));
							paymentDetails.setPaymentStatus(ejb.getPaymentStatusByStatus("Full Paid"));
							paymentDetails.setUniqueNo(Integer.parseInt(req.getParameter("uniqueNo")));
							...
							jobPlan = ejb.getJobPlanById(Integer.parseInt(req.getParameter("planNo1")));
							...
							for (JobPlanProducts jpp : jobPlan.getJobPlanProducts()) {
								for (int i = 0; i < jobPlan.getJobPlanProducts().size(); i++) {
									jobPlanProducts = ejb.getJobPlanProductsById(jpp.getId());
									jobPlanProducts.setComplete(true);
									ejb.updateJobPlanProducts(jobPlanProducts);
									for (JobPlanJobStock jpjs : jobPlanProducts.getJobPlanJobStock()) {
										jobPlanJobStock = ejb.getJobPlanJobStockById(jpjs.getId());
					...
					case "editproductSummary":
						...
						productDetail.setDescription(req.getParameter("description123").toUpperCase());
						...
						purchaseProductDetails = ejb.getInitialPurchase_Product_DetailsByProductId(proId).get(0);
						purchaseProductDetails.setQuantity(Float.parseFloat(req.getParameter("qty")));
						purchaseProductDetails.setRemaining_quantity(Float.parseFloat(req.getParameter("remQty")));
						purchaseProductDetails.setCost(Float.parseFloat(req.getParameter("cost")));
						...
						if (productDetail.isRaw()) {
							rawMaterialsStock = ejb.getRawMaterialStocktDetailByProductId(proId);
							rawMaterialsStock.setRemainingQty(
									rawMaterialsStock.getRemainingQty() - Float.parseFloat(req.getParameter("qtyH"))
											+ Float.parseFloat(req.getParameter("qty")));
							ejb.updateRawMaterialStockDetail(rawMaterialsStock);
							rawMaterialsStock = null;
						} else {
							readyGoodsStock = ejb.getReadyGoodsStocktDetailByProductId(proId);
							readyGoodsStock.setRemainingQty(
									readyGoodsStock.getRemainingQty() - Float.parseFloat(req.getParameter("qtyH"))
											+ Float.parseFloat(req.getParameter("qty")));
							ejb.updateReadyGoodsStockDetail(readyGoodsStock);
							readyGoodsStock = null;
						}
					...
					case "createSubDept":
						...
						if (counter == 0) {
							...
							subDepartment
									.setDepartment(ejb.getDepartmentById(Integer.parseInt(req.getParameter("deptId"))));
					...
					case "addVendor":
						...
						if (counter2 == 0) {
							...
							vendor.setVendorType(
									ejb.getVendorTypeById(Integer.parseInt(req.getParameter("vendorType"))));
							...
							if (!req.getParameter("vendorCSTregDate").equals("")) {
								accountDetails.setCstRegistrationDate(
										DateConverter.getDate(req.getParameter("vendorCSTregDate")));
							}
							if (!req.getParameter("vendorExciseRegDate").equals("")) {
								accountDetails.setCstRegistrationDate(
										DateConverter.getDate(req.getParameter("vendorExciseRegDate")));
							}
							...
							if (!req.getParameter("vendorVATregDate").equals("")) {
								accountDetails.setCstRegistrationDate(
										DateConverter.getDate(req.getParameter("vendorVATregDate")));
							}
							...
							if (!req.getParameter("taxTypeGroupId").equals("0")) {
								accountDetails.setTax_Type_Group(ejb
										.getTax_Type_GroupById(Integer.parseInt(req.getParameter("taxTypeGroupId"))));
							}
					...
					case "updateVendor":
						...
						accountDetails = ejb
								.getAccountDetailsByVendorId(Integer.parseInt(req.getParameter("vendoeId")));// vender
																												// id
					...
					case "purchaseEntry":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "pCodeIdH", "qtyH", "rateH", "lotH")) {
						...
						if (chP1 == 0) {
							...
							purchaseEntry.setSubTotal(Float.parseFloat(req.getParameter("subTotal")));
							...
							purchaseEntry.setDiscountValue(Float.parseFloat(req.getParameter("disValue"))); // this
																											// is
																											// not
																											// total
																											// discount.
							purchaseEntry.setDiscountTotal(Float.parseFloat(req.getParameter("discountValue"))); // this
																													// is
																													// total
																													// discount.

							if (req.getParameter("isEffective").equals("efectiveYes")) {
							...
							purchaseEntry.setAgentProfitValue(Float.parseFloat(req.getParameter("profitVal"))); // this
																												// is
																												// not
																												// total
																												// profit.
							purchaseEntry.setAgentProfitTotal(Float.parseFloat(req.getParameter("profitValue"))); // this
																													// is
																													// total
																													// profit.
							// //////////////////////////////////////////////////////////////
							...
							if (ejb.getVoucherAssignByVendorId(Integer.parseInt(req.getParameter("vId"))).size() == 0) {
								...
								voucherAssign = ejb
										.getVoucherAssignByVendorId(Integer.parseInt(req.getParameter("vId"))).get(0);
							}
							...
							if (!req.getParameter("pstatus").equals("Full Paid")) {
								...
								if (ejb.getVoucherDetailsByVendorId(Integer.parseInt(req.getParameter("vId")))
										.size() == 0) {
									voucherDetails
									...
									float totalCreditNote = vDetails.get(vDetails.size() - 1).getTotalCreditNote();
							...
							for (int l = 0; l < qty.length; l++) {
								...
								purchaseProductDetails.setAttrValue1(attr1[l].toUpperCase());
								purchaseProductDetails.setAttrValue2(attr2[l].toUpperCase());
								purchaseProductDetails.setAttrValue3(attr3[l].toUpperCase());
								purchaseProductDetails.setAttrValue4(attr4[l].toUpperCase());
								purchaseProductDetails.setAttrValue5(attr5[l].toUpperCase());
								purchaseProductDetails.setAttrValue6(attr6[l].toUpperCase());
								purchaseProductDetails
								...
								int lotNo = Integer
										.parseInt(ejb.getLastLotNoByProductId(Integer.parseInt(productId[l]))) + 1;
								...
								if (purchaseProductDetails.getProductDetail().isRaw()) {
									...
									rawMaterialsStock.setProductDetail(
											ejb.getProductDetailsById(Integer.parseInt(productId[l])));
									rawMaterialsStock.setRemainingQty(
											rawMaterialsStock.getRemainingQty() + Float.parseFloat(qty[l]));
									ejb.updateRawMaterialStockDetail(rawMaterialsStock);
									rawMaterialsStock = null;
								} else {
									...
									readyGoodsStock.setProductDetail(
											ejb.getProductDetailsById(Integer.parseInt(productId[l])));
									readyGoodsStock.setRemainingQty(
											readyGoodsStock.getRemainingQty() + Float.parseFloat(qty[l]));
									ejb.updateReadyGoodsStockDetail(readyGoodsStock);
									readyGoodsStock = null;
								}
							...
							if (purchaseEntry.getAgentId() != 0) {
								...
								if (ejb.getVoucherAssignByVendorId(purchaseEntry.getAgentId()).size() == 0) {
									voucherAssign = new VoucherAssign();
									vendor = ejb.getVendorById(purchaseEntry.getAgentId());
									voucherAssign.setVendor(vendor);
									voucherAssign.setVoucherDetailsNumber(vendor.getPh1());
									ejb.setVoucherAssign(voucherAssign);
								} else {
									voucherAssign = ejb.getVoucherAssignByVendorId(purchaseEntry.getAgentId()).get(0);
								}

								voucherDetForViaAgent = new VoucherDetailsForViaAgents();
								voucherDetForViaAgent.setVoucherAssignId(voucherAssign.getId());
								voucherDetForViaAgent.setAgentId(purchaseEntry.getAgentId());
								voucherDetForViaAgent.setPurchaseEntryId(purchaseEntry.getId());
								voucherDetForViaAgent.setCredit(true);
								voucherDetForViaAgent.setValue(purchaseEntry.getAgentProfitTotal());
								voucherDetForViaAgent.setVoucherDate(purchaseEntry.getPurchase_date());
								voucherDetForViaAgent.setEntryDate(new Date());
								voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);

								payDetForViaAgent = new PaymentDetailsForViaAgents();
								payDetForViaAgent.setPaymentDate(purchaseEntry.getPurchase_date());
								payDetForViaAgent.setEntryDate(new Date());
								payDetForViaAgent.setPaidAmount(0);
								payDetForViaAgent.setPurchaseEntryId(purchaseEntry.getId());
								payDetForViaAgent.setAgentId(purchaseEntry.getAgentId());
								payDetForViaAgent.setPaymentStatusId(ejb.getPaymentStatusByStatus("Not Paid").getId());
								payDetForViaAgent.setUniqueNo(uniqueNo);
								payDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
					...
					case "purchaseSearchForReturn":
						...
						List<Purchase_Entry> purEntryListR = ejb.getPurchaseEntryByChallanNo(
						...
						if (purEntryListR.size() > 0
								&& !purEntryListR.get(0).getVendor().getName().equals("Production Vendor")) {
							req.setAttribute("pId", purEntryListR.get(0).getId());

							msg = "Your search for Purchase challan number : " + req.getParameter("companyInitial")
					...
					case "purchaseReturn":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "rQty", "purProductDetailsID")) {
							req.setAttribute("msg", "Failed! Please try again!");
							req.getRequestDispatcher(page).forward(req, resp);
							return;
						}
						...
						companyInfo = ejb.getUserById((String) httpSession.getAttribute("user")).getCompanyInfo();
						purchaseEntry = ejb.getPurchaseEntryById(Integer.parseInt(req.getParameter("peId")));
						...
						if (chPR == 0) {
							...
							purchaseReturn.setChallanNumber(req.getParameter("challanNumber"));
							purchaseReturn.setRoundOff(Float.parseFloat(req.getParameter("roundvalue")));
							purchaseReturn.setReturnDate(DateConverter.getDate(req.getParameter("returnDate")));
							purchaseReturn.setChallanNo(Integer.parseInt(req.getParameter("challanNo")));
							purchaseReturn.setChallanSuffix(Integer.parseInt(req.getParameter("challanSuffix")));
							purchaseReturn.setTotalReCost(Float.parseFloat(req.getParameter("gTotal")));
							purchaseReturn.setReferencePurchaseChallan(req.getParameter("REFchallanNumber"));
							purchaseReturn.setPurchaseEntry(purchaseEntry);
							purchaseReturn.setRetAgentProfitTotal(Float.parseFloat(req.getParameter("profitValue")));
							...
							if (req.getParameter("pType").equals("Credit Note")) {
								...
								voucherDetails.setValue(Float.parseFloat(req.getParameter("spAmount")));
							...
							paymentDetails = new PaymentDetails();
							paymentDetails.setPaymentDate(DateConverter.getDate(req.getParameter("payDate")));
							paymentDetails.setTotalAmount(ejb.getPaymentDetailsByPurchaseEntryId(purchaseEntry.getId())
									.get(0).getTotalAmount()
									- ejb.getPaymentDetailsByPurchaseEntryId(purchaseEntry.getId()).get(0)
											.getPaidAmount());
							paymentDetails.setPaidAmount(Float.parseFloat(req.getParameter("spAmount")));
							paymentDetails.setDescription(req.getParameter("desc"));
							paymentDetails.setPurchaseReturn(purchaseReturn);
							paymentDetails.setPurchase_Entry(purchaseEntry);
							paymentDetails.setPaymentType(ejb.getPaymentTypeByType(req.getParameter("pType")));
							if (ejb.getPaymentDetailsByPurchaseEntryId(purchaseEntry.getId()).get(0).getTotalAmount()
									- ejb.getPaymentDetailsByPurchaseEntryId(purchaseEntry.getId()).get(0)
											.getPaidAmount() > Float.parseFloat(req.getParameter("spAmount"))) {
							...
							String purProductDetailsID[] = req.getParameterValues("purProductDetailsID");

							for (int l = 0; l < db.length; l++) {
								if (!rQty[l].equals("0")) {
									if (!rQty[l].equals("")) {
										purchaseProductDetails = ejb.getPurchaseProductDetailsById(
												Integer.parseInt(purProductDetailsID[l]));
										purchaseProductDetails
												.setTotalReturningQty(purchaseProductDetails.getTotalReturningQty()
														+ Float.parseFloat(rQty[l]));
										purchaseProductDetails
												.setRemaining_quantity(purchaseProductDetails.getRemaining_quantity()
														- Float.parseFloat(rQty[l]));
										...
										if (purchaseProductDetails.getProductDetail().isRaw()) {
											...
											readyGoodsStock = ejb.getReadyGoodStoctByProductAndCompanyId(
													...
													companyInfo.getId());
											readyGoodsStock.setRemainingQty(
													readyGoodsStock.getRemainingQty() - Float.parseFloat(rQty[l]));
											ejb.updateReadyGoodsStockDetail(readyGoodsStock);
											readyGoodsStock = null;
										}
									}
							...
							// new to check
							if (purchaseEntry.getAgentId() != 0 && purchaseEntry.isEfectiveProfit()) {
								uniqueNo = ejb.getLastUniqueNoOfPayDet4ViaAgent() + 1;

								voucherDetForViaAgent = new VoucherDetailsForViaAgents();
								voucherDetForViaAgent.setVoucherAssignId(
										ejb.getVoucherAssignByVendorId(purchaseEntry.getAgentId()).get(0).getId());
								voucherDetForViaAgent.setAgentId(purchaseEntry.getAgentId());
								voucherDetForViaAgent.setPurchaseEntryId(purchaseEntry.getId());
								voucherDetForViaAgent.setPurchaseReturnId(purchaseReturn.getId());
								voucherDetForViaAgent.setCredit(false);
								voucherDetForViaAgent.setValue(purchaseReturn.getRetAgentProfitTotal());
								voucherDetForViaAgent.setVoucherDate(purchaseReturn.getReturnDate());
								voucherDetForViaAgent.setEntryDate(new Date());
								voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);

								payDetForViaAgent = new PaymentDetailsForViaAgents();
								payDetForViaAgent.setPaymentDate(purchaseReturn.getReturnDate());
								payDetForViaAgent.setEntryDate(new Date());
								payDetForViaAgent.setPaidAmount(purchaseReturn.getRetAgentProfitTotal());
								payDetForViaAgent.setPurchaseEntryId(purchaseEntry.getId());
								payDetForViaAgent.setPurchaseReturnId(purchaseReturn.getId());
								payDetForViaAgent.setAgentId(purchaseEntry.getAgentId());
								payDetForViaAgent.setPaymentTypeId(ejb.getPaymentTypeByType("Credit Note").getId());
								payDetForViaAgent.setPaymentStatusId(ejb.getPaymentStatusByStatus("Semi Paid").getId());
								payDetForViaAgent.setUniqueNo(uniqueNo);
								payDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setPaymentDetails4ViaAgent(payDetForViaAgent);
							}
					...
					case "salesEntry":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "productId", "qtyvalue", "mrpQty", "purchaseProductDetId")) {
							req.setAttribute("msg", "Failed! Please try again!");
							req.getRequestDispatcher(page).forward(req, resp);
							return;
						}
						...
						for (SalesEntry se : sEntry) {
							if (se.getChallanNumber().equals(req.getParameter("challanNumber"))) {
								chS = 1;
								break;
							}
						}
						if (chS == 0) {
							if (req.getParameter("isExistingCust").equals("0")) {
								...
								voucherAssign.setVoucherDetailsNumber(customerEntry.getMobile());
								ejb.setVoucherAssign(voucherAssign);

							} else {
								voucherAssign = ejb.getVoucherAssignByCustomerId(
							...
							salesEntry.setTax_Type_Group(
									ejb.getTax_Type_GroupById(Integer.parseInt(req.getParameter("taxGroup"))));
							salesEntry.setSubTotal(Float.parseFloat(req.getParameter("subtotalvalue")));
							salesEntry.setTaxAmount(Float.parseFloat(req.getParameter("taxAmount")));
							...
							salesEntry.setDescription(req.getParameter("salesDesc").toUpperCase());

							if (!req.getParameter("aId").equals("")) {
								salesEntry.setVendor(ejb.getVendorById(Integer.parseInt(req.getParameter("aId"))));
							}
							...
							if (req.getParameter("isExistingCust").equals("0")) {
								...
								salesEntry.setCustomer(
										ejb.getCustomerEntryById(Integer.parseInt(req.getParameter("existingCustId"))));
							}

							salesEntry.setDiscountValue(Float.parseFloat(req.getParameter("disValue"))); // this
																											// is
																											// not
																											// total
																											// discount.
							...
							salesEntry.setAgentProfitValue(Float.parseFloat(req.getParameter("profitVal"))); // this
																												// is
																												// not
																												// total
																												// profit.
							salesEntry.setAgentProfitTotal(Float.parseFloat(req.getParameter("profitValue"))); // this
																												// is
																												// total
																												// profit.
							// //////////////////////////////////////////////////////////////
							...
							if (!req.getParameter("pstatus").equals("Full Paid")) {
								...
								if (!req.getParameter("existingCustId").equals("")) {
									List<VoucherDetails> vDetails = ejb.getLastVoucherDetailsbyCustomerId(
											Integer.parseInt(req.getParameter("existingCustId")));
									voucherDetails.setTotalDebitNote(vDetails.size() > 0
											? vDetails.get(vDetails.size() - 1).getTotalDebitNote()
													+ Float.parseFloat(req.getParameter("spDueAmount"))
											: 0 + Float.parseFloat(req.getParameter("spDueAmount")));
								}
							...
							for (int l = 0; l < productId.length; l++) {
								...
								purchaseProductDetails.setRemaining_quantity(
										purchaseProductDetails.getRemaining_quantity() - Float.parseFloat(qtyvalue[l]));
								...
								if (purchaseProductDetails.getProductDetail().isRaw()) {
									...
									rawMaterialsStock.setRemainingQty(
											rawMaterialsStock.getRemainingQty() - Float.parseFloat(qtyvalue[l]));
									...
									readyGoodsStock.setRemainingQty(
											readyGoodsStock.getRemainingQty() - Float.parseFloat(qtyvalue[l]));
							...
							if (salesEntry.getVendor() != null) {
								uniqueNo = ejb.getLastUniqueNoOfPayDet4ViaAgent() + 1;
								if (ejb.getVoucherAssignByVendorId(salesEntry.getVendor().getId()).size() == 0) {
									voucherAssign = new VoucherAssign();
									vendor = ejb.getVendorById(salesEntry.getVendor().getId());
									voucherAssign.setVendor(vendor);
									voucherAssign.setVoucherDetailsNumber(vendor.getPh1());
									ejb.setVoucherAssign(voucherAssign);
								} else {
									voucherAssign = ejb.getVoucherAssignByVendorId(salesEntry.getVendor().getId())
											.get(0);
								}

								voucherDetForViaAgent = new VoucherDetailsForViaAgents();
								voucherDetForViaAgent.setVoucherAssignId(voucherAssign.getId());
								voucherDetForViaAgent.setAgentId(salesEntry.getVendor().getId());
								voucherDetForViaAgent.setSalesEntryId(salesEntry.getId());
								voucherDetForViaAgent.setCredit(true);
								voucherDetForViaAgent.setValue(salesEntry.getAgentProfitTotal());
								voucherDetForViaAgent.setVoucherDate(salesEntry.getSales_date());
								voucherDetForViaAgent.setEntryDate(new Date());
								voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);

								payDetForViaAgent = new PaymentDetailsForViaAgents();
								payDetForViaAgent.setPaymentDate(salesEntry.getSales_date());
								payDetForViaAgent.setEntryDate(new Date());
								payDetForViaAgent.setPaidAmount(0);
								payDetForViaAgent.setSalesEntryId(salesEntry.getId());
								payDetForViaAgent.setAgentId(salesEntry.getVendor().getId());
								payDetForViaAgent.setPaymentStatusId(ejb.getPaymentStatusByStatus("Not Paid").getId());
								payDetForViaAgent.setUniqueNo(uniqueNo);
								payDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setPaymentDetails4ViaAgent(payDetForViaAgent);
					...
					case "purchaseSearchByDate":
						...
						List<Purchase_Entry> purEntryList = ejb.getPurchaseEntryByDateAndCompany(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")),
								ejb.getUserById((String) httpSession.getAttribute("user")).getCompanyInfo().getId());
						req.setAttribute("purEntryList", purEntryList);
						if (purEntryList.size() > 0) {
							msg = "Your search for dated " + req.getParameter("fDate") + " to "
									+ req.getParameter("lDate");
						} else {
							msg = "No result found for dated " + req.getParameter("fDate") + " to "
									+ req.getParameter("lDate") + "...";
						}
						break;
					...
					case "purchaseSearchByDateForViaPurchaseAgent":
						...
						List<Purchase_Entry> purEntryListFVPA = ejb.getPurchaseEntryByDateAndCompany(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")),
								ejb.getUserById((String) httpSession.getAttribute("user")).getCompanyInfo().getId());
					...
					case "purchaseProductionSearchByDate":
						...
						List<Purchase_Entry> purEntryListP = ejb.getPurchaseEntryByDateAndCompany(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")),
								ejb.getUserById((String) httpSession.getAttribute("user")).getCompanyInfo().getId());
					...
					case "purchaseReportByDate":
						...
						List<Purchase_Entry> purEntryListRp = ejb.getPurchaseEntryByDateAndCompany(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")),
								ejb.getUserById((String) httpSession.getAttribute("user")).getCompanyInfo().getId());
					...
					case "purchaseSearchByPurchaseChallanNo":
						page = "purchasingPurchaseSearch.jsp";
						List<Purchase_Entry> purEntryList1 = ejb.getPurchaseEntryByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "purchaseSearchByPurchaseChallanNoForViaPurchaseAgent":
						page = "purchaseAgentProfitPayment.jsp";
						List<Purchase_Entry> purEntryList1FVPA = ejb.getPurchaseEntryByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "purchaseProductionSearchByPurchaseChallanNo":
						page = "purchasingProductionSearch.jsp";
						List<Purchase_Entry> purEntryList1P = ejb.getPurchaseEntryByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
						...
						if (purEntryList1P.size() > 0) {
							msg = "Your search for Challan number : " + req.getParameter("companyInitial") + "/"
									+ req.getParameter("fynYear") + "/" + req.getParameter("month") + "/"
									+ req.getParameter("billType") + "/" + req.getParameter("autoNum") + "/"
									+ req.getParameter("suffix");
						} else {
							msg = "No result found for Challan number : " + req.getParameter("companyInitial") + "/"
									+ req.getParameter("fynYear") + "/" + req.getParameter("month") + "/"
									+ req.getParameter("billType") + "/" + req.getParameter("autoNum") + "/"
									+ req.getParameter("suffix");
						}
					...
					case "purchaseSearchByVendorName":
						...
						List<Purchase_Entry> purEntryList2 = ejb
								.getPurchaseEntryByVendorNameAndCompany(req.getParameter("vendorName"));
					...
					case "purchaseReportByVendorName":
						...
						List<Purchase_Entry> purEntryList2R = ejb
								.getAllPurchaseEntryByVendorIdTypeVendor(Integer.parseInt(req.getParameter("pId")));
					...
					case "purchaseSearchByAgentName":
						...
						List<Purchase_Entry> purEntryList3 = ejb
								.getPurchaseEntryByAgentNameAndCompany(req.getParameter("agentName"));
					...
					case "purchaseSearchByAgentNameForViaPurchaseAgent":
						...
						List<Purchase_Entry> purEntryList3FVA = ejb
								.getPurchaseEntryByViaAgentId(Integer.parseInt(req.getParameter("VagentId")));
						req.setAttribute("purEntryList", purEntryList3FVA);
						if (purEntryList3FVA.size() > 0) {
							msg = "Your search for Agent name : " + req.getParameter("VagentName").toUpperCase();
						} else {
							msg = "No result found for Agent name : " + req.getParameter("VagentName").toUpperCase();
						}
						break;
					...
					case "purchaseReportByAgentName":
						...
						List<Purchase_Entry> purEntryList3R = ejb.getAllPurchaseEntryByVendorIdTypePurchaseAgent(
					...
					case "purchaseSearchByProductCode":
						...
						List<Purchase_Entry> purEntryList4 = ejb
								.getPurchaseEntryByProductCodeAndCompany(req.getParameter("prodCode"));
					...
					case "purchaseReportByProductCode":
						...
						List<Purchase_Entry> purEntryList4R = ejb
								.getPurchaseEntryByProductId(Integer.parseInt(req.getParameter("pId")));
					...
					case "purchaseSearchAll":
						page = "purchasingPurchaseSearch.jsp";
						List<Purchase_Entry> purEntryListA = ejb.getAllPurchaseEntryByCompany();
					...
					case "purchaseSearchAllForViaPurchaseAgent":
						page = "purchaseAgentProfitPayment.jsp";
						List<Purchase_Entry> purEntryList4VPA = ejb.getAllPurchaseEntry();
					...
					case "purchaseProductionSearchAll":
						page = "purchasingProductionSearch.jsp";
						List<Purchase_Entry> purEntryListAP = ejb.getAllPurchaseEntryByCompany();
					...
					case "allPurchaseReport":
						page = "reportPurchaseReport.jsp";
						List<Purchase_Entry> purEntryListAR = ejb.getAllPurchaseEntryByCompany();
						...
						for (int q = 0; q < qtyLst.length; q++) {
							if (qtyLst[q] != null || qtyLst[q] != "") {
								Purchase_Product_Details ppd = ejb
										.getPurchaseProductDetailsById(Integer.parseInt(purProdDetIdLst[q]));
					...
					case "purchaseReturnSearchAll":
						...
						List<PurchaseReturn> purRetA = ejb.getAllPurchaseReturnDesc();
						if (purRetA.size() > 0) {
					...
					case "purchaseReturnSearchByDate":
						page = "purchaseReturnSearch.jsp";
						List<PurchaseReturn> purRetD = ejb.getPurchaseReturnByDate(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")));
					...
					case "purchaseRetSearchByChallanNo":
						page = "purchaseReturnSearch.jsp";
						List<PurchaseReturn> purRetC = ejb.getPurchaseReturnByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "purchaseRetSearchByRefChallanNo":
						page = "purchaseReturnSearch.jsp";
						List<PurchaseReturn> purRetRC = ejb.getPurchaseReturnByReferenceChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
						...
						if (purRetRC.size() > 0) {
							msg = "Your search for Reference challan number : " + req.getParameter("companyInitial")
									+ "/" + req.getParameter("fynYear") + "/" + req.getParameter("month") + "/"
									+ req.getParameter("billType") + "/" + req.getParameter("autoNum") + "/"
									+ req.getParameter("suffix");
						} else {
							msg = "No result found for Reference challan number : " + req.getParameter("companyInitial")
									+ "/" + req.getParameter("fynYear") + "/" + req.getParameter("month") + "/"
									+ req.getParameter("billType") + "/" + req.getParameter("autoNum") + "/"
									+ req.getParameter("suffix");
						}
					...
					case "purchaseRetSearchByProductCode":
						page = "purchaseReturnSearch.jsp";
						List<PurchaseReturn> purRetP = ejb.getPurchaseReturnByProductCode(req.getParameter("prodCode"));
					...
					case "purchaseRetSearchByVendorName":
						...
						List<PurchaseReturn> purRetV = ejb
								.getPurchaseReturnByVendorName(req.getParameter("vendorName"));
					...
					case "purchaseRetSearchByAgentName":
						page = "purchaseReturnSearch.jsp";
						List<PurchaseReturn> purRetAg = ejb.getPurchaseReturnByAgentName(req.getParameter("agentName"));
					...
					case "purchaseRetSearchByViaAgentNamet":
						...
						List<PurchaseReturn> purRetVAg = ejb
								.getPurchaseReturnByViaAgentId(Integer.parseInt(req.getParameter("VagentId")));
					...
					case "purchaseProductView":
						...
						req.setAttribute("pId", req.getParameter("pId"));
						req.setAttribute("purEntryList",
								ejb.getPurchaseEntryByProductCodeAndCompany(req.getParameter("prodCode")));
					...
					case "purchasePayment":
						...
						for (PaymentDetails pd : ejb.getAllPaymentDetails()) {
							if (pd.getUniqueNo() == Integer.parseInt(req.getParameter("uniqueNo"))) {
								isDuplicateP = true;
								break;
							}
						}
						...
						if (isDuplicateP) {
							...
							if (ejb.getAllVoucherDetailsByPurchaseEntryId(Integer.parseInt(req.getParameter("peId")))
									.size() == 0) {
								if (!req.getParameter("pstatus").equals("Full Paid")) {
									voucherDetails = new VoucherDetails();
									voucherDetails.setVoucherAssign(voucherAssign);
									...
									voucherDetails.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
									voucherDetails.setUsers(ejb.getUserById((String) httpSession.getAttribute("user")));
									voucherDetails.setPurchase_Entry(
											ejb.getPurchaseEntryById(Integer.parseInt(req.getParameter("peId"))));
									ejb.setVoucherDetails(voucherDetails);
								}
							} else {
								voucherDetails = new VoucherDetails();
								voucherDetails.setVoucherAssign(voucherAssign);
								voucherDetails.setCredit(false);
								voucherDetails.setValue(Float.parseFloat(req.getParameter("spPaymentAmount")));
								List<VoucherDetails> vDetails = ejb
										.getVoucherDetailsByVendorId(Integer.parseInt(req.getParameter("vId")));
								float totalCreditNote = vDetails.get(vDetails.size() - 1).getTotalCreditNote();
								voucherDetails.setTotalCreditNote(
										totalCreditNote - Float.parseFloat(req.getParameter("spPaymentAmount")));
								voucherDetails.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
								voucherDetails.setUsers(ejb.getUserById((String) httpSession.getAttribute("user")));
								voucherDetails.setPurchase_Entry(
										ejb.getPurchaseEntryById(Integer.parseInt(req.getParameter("peId"))));
							...
							paymentDetails.setTotalAmount(ejb
									.getPaymentDetailsByPurchaseEntryId(Integer.parseInt(req.getParameter("peId")))
									.get(0).getTotalAmount()
									- ejb.getPaymentDetailsByPurchaseEntryId(Integer.parseInt(req.getParameter("peId")))
											.get(0).getPaidAmount());
							paymentDetails.setPaidAmount(Float.parseFloat(req.getParameter("spPaymentAmount")));
							paymentDetails.setDescription(req.getParameter("desc"));
							paymentDetails.setPurchase_Entry(
									ejb.getPurchaseEntryById(Integer.parseInt(req.getParameter("peId"))));
							paymentDetails.setPaymentType(ejb.getPaymentTypeByType(req.getParameter("pType")));
							paymentDetails.setPaymentStatus(ejb.getPaymentStatusByStatus(req.getParameter("pstatus")));
							paymentDetails.setUniqueNo(Integer.parseInt(req.getParameter("uniqueNo")));
					...
					case "salesPayment":
						...
						if (isDuplicateS) {
							...
							if (ejb.getVoucherAssignByCustomerId(Integer.parseInt(req.getParameter("cId"))) == null) {
								voucherAssign = new VoucherAssign();
								customerEntry = ejb.getCustomerEntryById(Integer.parseInt(req.getParameter("cId")));
								voucherAssign.setCustomerEntry(customerEntry);
								voucherAssign.setVoucherDetailsNumber(customerEntry.getMobile());
								ejb.setVoucherAssign(voucherAssign);
							} else {
								voucherAssign = ejb
										.getVoucherAssignByCustomerId(Integer.parseInt(req.getParameter("cId")));
							}

							if (ejb.getAllVoucherDetailsBySalesEntryId(Integer.parseInt(req.getParameter("seId")))
									.size() == 0) {
								if (!req.getParameter("pstatus").equals("Full Paid")) {
									voucherDetails = new VoucherDetails();
									voucherDetails.setSalesEntry(
											ejb.getSalesEntryById(Integer.parseInt(req.getParameter("seId"))));
									voucherDetails.setCredit(false);
									voucherDetails.setValue(Float.parseFloat(req.getParameter("spDueAmount")));
									voucherDetails.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
									voucherDetails
											.setUsers(ejb.getUserById(httpSession.getAttribute("user").toString()));
									List<VoucherDetails> vDetails = ejb.getLastVoucherDetailsbyCustomerId(
								...
								voucherDetails.setTotalDebitNote(vDetails.get(vDetails.size() - 1).getTotalDebitNote()
							...
							// .getParameter("spAmount")));
							paymentDetails.setTotalAmount(ejb
									.getPaymentDetailsBySalesEntryId(Integer.parseInt(req.getParameter("seId"))).get(0)
									.getTotalAmount()
									- ejb.getPaymentDetailsBySalesEntryId(Integer.parseInt(req.getParameter("seId")))
											.get(0).getPaidAmount());
							paymentDetails.setPaidAmount(Float.parseFloat(req.getParameter("spPaymentAmount")));
							paymentDetails.setDescription(req.getParameter("desc"));
							paymentDetails
									.setSalesEntry(ejb.getSalesEntryById(Integer.parseInt(req.getParameter("seId"))));
							paymentDetails.setPaymentType(ejb.getPaymentTypeByType(req.getParameter("pType")));
							paymentDetails.setPaymentStatus(ejb.getPaymentStatusByStatus(req.getParameter("pstatus")));
							paymentDetails.setUniqueNo(Integer.parseInt(req.getParameter("uniqueNo")));
							ejb.setPaymentDetails(paymentDetails);
					...
					case "salesAgentPayment":
						...
						List<SalesEntry> salesEntryLst4AP = ejb.getAllSalesEntriesByCompany();
						req.setAttribute("salesEntryLst", salesEntryLst4AP);

						boolean isDuplicateSAP = false;
						for (PaymentDetailsForViaAgents pd : ejb.getAllPaymentDetails4ViaAgent()) {
							if (pd.getUniqueNo() == Integer.parseInt(req.getParameter("uniqueNo"))) {
								isDuplicateSAP = true;
								break;
							}
						...
						if (isDuplicateSAP) {
							...
							if (ejb.getVoucherAssignByVendorId(Integer.parseInt(req.getParameter("aId"))).size() == 0) {
								voucherAssign = new VoucherAssign();
								vendor = ejb.getVendorById(Integer.parseInt(req.getParameter("aId")));
								voucherAssign.setVendor(vendor);
								voucherAssign.setVoucherDetailsNumber(vendor.getPh1());
								ejb.setVoucherAssign(voucherAssign);
							} else {
								voucherAssign = ejb
										.getVoucherAssignByVendorId(Integer.parseInt(req.getParameter("aId"))).get(0);
							}
							...
							if (ejb.getAllVoucherDetails4ViaAgentBySalesEntryId(
								...
								if (!req.getParameter("pstatus").equals("Full Paid")) {
									voucherDetForViaAgent = new VoucherDetailsForViaAgents();
									voucherDetForViaAgent.setVoucherAssignId(voucherAssign.getId());
									voucherDetForViaAgent.setAgentId(Integer.parseInt(req.getParameter("aId")));
									voucherDetForViaAgent.setSalesEntryId(Integer.parseInt(req.getParameter("seId")));
									voucherDetForViaAgent.setCredit(true);
									voucherDetForViaAgent.setValue(Float.parseFloat(req.getParameter("spDueAmount")));
									voucherDetForViaAgent
											.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
									voucherDetForViaAgent.setEntryDate(new Date());
									voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
									ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);
								}
								...
								voucherDetForViaAgent.setSalesEntryId(Integer.parseInt(req.getParameter("seId")));
								voucherDetForViaAgent.setCredit(false);
								voucherDetForViaAgent.setValue(Float.parseFloat(req.getParameter("spPaymentAmount")));
								voucherDetForViaAgent
										.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
								voucherDetForViaAgent.setEntryDate(new Date());
								voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
							...
							payDetForViaAgent = new PaymentDetailsForViaAgents();
							payDetForViaAgent.setPaymentDate(DateConverter.getDate(req.getParameter("payDate")));
							payDetForViaAgent.setEntryDate(new Date());
							payDetForViaAgent.setPaidAmount(Float.parseFloat(req.getParameter("spPaymentAmount")));
							payDetForViaAgent.setDescription(req.getParameter("desc"));
							payDetForViaAgent.setSalesEntryId(Integer.parseInt(req.getParameter("seId")));
							payDetForViaAgent.setAgentId(Integer.parseInt(req.getParameter("aId")));
							payDetForViaAgent
									.setPaymentTypeId(ejb.getPaymentTypeByType(req.getParameter("pType")).getId());
							payDetForViaAgent.setPaymentStatusId(
									ejb.getPaymentStatusByStatus(req.getParameter("pstatus")).getId());
							payDetForViaAgent.setUniqueNo(Integer.parseInt(req.getParameter("uniqueNo")));
							payDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
							ejb.setPaymentDetails4ViaAgent(payDetForViaAgent);
							msg = "Successful!";
						}
					...
					case "purchaseAgentPayment":
						page = "purchaseAgentProfitPayment.jsp";
						List<Purchase_Entry> purEntryLst4PAP = ejb.getAllPurchaseEntry();
						...
						if (isDuplicate4PAP) {
							...
							if (ejb.getAllVoucherDetails4ViaAgentByPurchaseEntryId(
								...
								if (!req.getParameter("pstatus").equals("Full Paid")) {
									...
									voucherDetForViaAgent.setAgentId(Integer.parseInt(req.getParameter("aId")));
									voucherDetForViaAgent
											.setPurchaseEntryId(Integer.parseInt(req.getParameter("peId")));
									voucherDetForViaAgent.setCredit(true);
									voucherDetForViaAgent.setValue(Float.parseFloat(req.getParameter("spDueAmount")));
									voucherDetForViaAgent
											.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
								...
								voucherDetForViaAgent.setVoucherAssignId(voucherAssign.getId());
								voucherDetForViaAgent.setAgentId(Integer.parseInt(req.getParameter("aId")));
								voucherDetForViaAgent.setPurchaseEntryId(Integer.parseInt(req.getParameter("peId")));
								voucherDetForViaAgent.setCredit(false);
								voucherDetForViaAgent.setValue(Float.parseFloat(req.getParameter("spPaymentAmount")));
								voucherDetForViaAgent
										.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
							...
							payDetForViaAgent.setPaidAmount(Float.parseFloat(req.getParameter("spPaymentAmount")));
							payDetForViaAgent.setDescription(req.getParameter("desc"));
							payDetForViaAgent.setPurchaseEntryId(Integer.parseInt(req.getParameter("peId")));
							payDetForViaAgent.setAgentId(Integer.parseInt(req.getParameter("aId")));
							payDetForViaAgent
									.setPaymentTypeId(ejb.getPaymentTypeByType(req.getParameter("pType")).getId());
							payDetForViaAgent.setPaymentStatusId(
					...
					case "jobPayment":
						page = "jobPayment.jsp";
						List<JobAssignmentDetails> jobAssignListAPP = ejb.getAllJobassignmentDetails();
						...
						if (isDuplicateJ) {
							...
							if (ejb.getAllVoucherDetailsByJobAssignId(Integer.parseInt(req.getParameter("jaId")))
									.size() == 0) {
								if (!req.getParameter("pstatus").equals("Full Paid")) {
									voucherDetails = new VoucherDetails();
									voucherDetails.setVoucherAssign(voucherAssign);
									...
									voucherDetails.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
									voucherDetails.setUsers(ejb.getUserById((String) httpSession.getAttribute("user")));
									voucherDetails.setJobAssignId(Integer.parseInt(req.getParameter("jaId")));
									ejb.setVoucherDetails(voucherDetails);
								}
							} else {
								voucherDetails = new VoucherDetails();
							...
							paymentDetails = new PaymentDetails();
							paymentDetails.setPaymentDate(DateConverter.getDate(req.getParameter("payDate")));
							if (ejb.getPaymentDetailsByJobAsignId(Integer.parseInt(req.getParameter("jaId")))
									.size() > 0) {
								paymentDetails.setTotalAmount(ejb
										.getPaymentDetailsByJobAsignId(Integer.parseInt(req.getParameter("jaId")))
										.get(0).getTotalAmount()
										- ejb.getPaymentDetailsByJobAsignId(Integer.parseInt(req.getParameter("jaId")))
												.get(0).getPaidAmount());
							} else {
								paymentDetails.setTotalAmount(Float.parseFloat(req.getParameter("spAmount")));
							}
							paymentDetails.setPaidAmount(Float.parseFloat(req.getParameter("spPaymentAmount")));
							paymentDetails.setDescription(req.getParameter("desc"));
							paymentDetails.setJobAssignId(Integer.parseInt(req.getParameter("jaId")));
							paymentDetails.setPaymentType(ejb.getPaymentTypeByType(req.getParameter("pType")));
							paymentDetails.setPaymentStatus(ejb.getPaymentStatusByStatus(req.getParameter("pstatus")));
							paymentDetails.setUniqueNo(Integer.parseInt(req.getParameter("uniqueNo")));
							ejb.setPaymentDetails(paymentDetails);
					...
					case "jobAssignment":
						...
						jobAssignmentDetails.setEstimatedCompletionDate(
								DateConverter.getDate(req.getParameter("estSubmissionDate")));
						...
						for (int l = 0; l < pProdDetIdH.length; l++) {
							...
							purchaseProductDetails = ejb
									.getPurchaseProductDetailsById(Integer.parseInt(pProdDetIdH[l]));
							purchaseProductDetails.setRemaining_quantity(
							...
							rawMaterialsStock = ejb.getRawMeterialStoctByProductAndCompanyId(
									purchaseProductDetails.getProductDetail().getId(), companyInfo.getId());
							rawMaterialsStock
									.setRemainingQty(rawMaterialsStock.getRemainingQty() - Integer.parseInt(qtyH[l]));
							ejb.updateRawMaterialStockDetail(rawMaterialsStock);
					...
					case "jobReceiveFromSearch":
						...
						List<JobAssignmentDetails> jobAssignListRS = ejb
								.getJobAssignmentDetailsbyChallanNumber(req.getParameter("joChallan"));

						if (jobAssignListRS.size() > 0) {
							req.setAttribute("amj", jobAssignListRS.get(0));
							msg = "Your search for Job challan number : " + req.getParameter("joChallan");
						} else {
							msg = "No result found for Job challan number : " + req.getParameter("joChallan");
						}
					...
					case "jobAssignSearchByDate":
						...
						List<JobAssignmentDetails> jobAssignList = ejb.getJobAsignmentByDate(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")));
					...
					case "jobAssignSearchByDateForPayment":
						page = "jobPayment.jsp";
						List<JobAssignmentDetails> jobAssignListFP = ejb.getJobAsignmentByDate(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")));
					...
					case "jobSearchByJobChallanNo":
						page = "jobAssignSearch.jsp";
						List<JobAssignmentDetails> jobAssignList1 = ejb.getJobAssignByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "jobSearchByJobChallanNoForPayment":
						page = "jobPayment.jsp";
						List<JobAssignmentDetails> jobAssignListCP = ejb.getJobAssignByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "jobSearchByPlanNo":
						...
						List<JobAssignmentDetails> jobAssignListP = ejb
								.getJobAssignByPlanNumber(Integer.parseInt(req.getParameter("planNo")));
						req.setAttribute("jobAssignList", jobAssignListP);
						if (jobAssignListP.size() > 0) {
							msg = "Your search for Plan Number : " + req.getParameter("planNo").toUpperCase();
						} else {
							msg = "No result found for Plan Number : " + req.getParameter("planNo").toUpperCase();
						}
						break;
					...
					case "jobSearchAll":
						page = "jobAssignSearch.jsp";
						List<JobAssignmentDetails> jobAssignListA = ejb.getAllJobassignmentDetails();
					...
					case "jobSearchAllForPayment":
						page = "jobPayment.jsp";
						List<JobAssignmentDetails> jobAssignListAP = ejb.getAllJobassignmentDetails();
					...
					case "sampleJobSearchAll":
						...
						List<SampleDesignCostSheet> sampleDesignCostSheetListA = ejb.getAllSampleDesignCostSheet();
						req.setAttribute("sampleDesignCostSheetList", sampleDesignCostSheetListA);
					...
					case "sampleJobSearchByDesignNo":
						...
						List<SampleDesignCostSheet> sampleDesignCostSheetListD = ejb
								.getSampleCostSheetByDesignNumber(req.getParameter("designNo"));
						req.setAttribute("sampleDesignCostSheetList", sampleDesignCostSheetListD);
						if (sampleDesignCostSheetListD.size() > 0) {
							msg = "Your search for Design no. : " + req.getParameter("designNo").toUpperCase();
						} else {
							msg = "No result found for Design no. : " + req.getParameter("designNo").toUpperCase();
						}
						break;
					...
					case "sampleJobSearchByDesignerName":
						...
						List<SampleDesignCostSheet> sampleDesignCostSheetListDR = ejb
								.getSampleDesignCostSheetByDesignerName(req.getParameter("designerName"));
						req.setAttribute("sampleDesignCostSheetList", sampleDesignCostSheetListDR);
						if (sampleDesignCostSheetListDR.size() > 0) {
							msg = "Your search for Designer name : " + req.getParameter("designerName").toUpperCase();
						} else {
					...
					case "sampleJobCostSheetView":
						...
						req.setAttribute("sampleDesignCostSheetId", req.getParameter("sampleDesignCostSheetId"));
					...
					case "salesSearchByDateForAgent":
						...
						List<SalesEntry> salesEntryLstDA = ejb.getSalesEntryByDate(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")));
					...
					case "salesSearchBySalesChallanNo":
						...
						List<SalesEntry> salesEntryLst1 = ejb.getSalesEntryByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "salesSearchBySalesChallanNoForAgent":
						...
						List<SalesEntry> salesEntryLstCA = ejb.getSalesEntryByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "salesSearchByAgentName":
						page = "salesSearch.jsp";
						List<SalesEntry> salesEntryLst2 = ejb.getSalesEntryByAgentName(req.getParameter("agentName"));
					...
					case "salesSearchByAgentNameForAgent":
						page = "salesAgentProfitPayment.jsp";
						List<SalesEntry> salesEntryLst2AA = ejb.getSalesEntryByAgentName(req.getParameter("agentName"));
					...
					case "salesReportByAgentName":
						...
						List<SalesEntry> salesEntryLst2R = ejb
								.getSalesEntryByAgentId(Integer.parseInt(req.getParameter("pId")));
					...
					case "salesSearchByCustomerName":
						...
						List<SalesEntry> salesEntryLst3 = ejb
								.getSalesEntryByCustomerName(req.getParameter("custoName"));
					...
					case "salesReportByCustomerName":
						...
						List<SalesEntry> salesEntryLst3R = ejb
								.getSalesEntryByCustomerId(Integer.parseInt(req.getParameter("pId")));
					...
					case "salesSearchByProductCode":
						...
						List<SalesEntry> salesEntryLst4 = ejb
								.getSalesEntriesByProductCode(req.getParameter("prodCode"));
					...
					case "salesSearchAll":
						page = "salesSearch.jsp";
						List<SalesEntry> salesEntryLstA = ejb.getAllSalesEntriesByCompany();
					...
					case "salesSearchAllForAgent":
						page = "salesAgentProfitPayment.jsp";
						List<SalesEntry> salesEntryLstAA = ejb.getAllSalesEntriesByCompany();
					...
					case "salesRerturnSearchByDate":
						...
						List<SalesReturn> salesRetLstByDt = ejb.getSalesReturnByDate(
								DateConverter.getDate(req.getParameter("fDate")),
								DateConverter.getDate(req.getParameter("lDate")));
					...
					case "salesReturnSearchByChallanNo":
						...
						List<SalesReturn> salesRetLstByCh = ejb.getSalesReturnByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "salesReturnSearchByRefChallanNo":
						...
						List<SalesReturn> salesRetLstByRef = ejb.getSalesReturnByRefChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
					...
					case "salesReturnSearchByCustomerName":
						...
						List<SalesReturn> salesRetLstByc = ejb
								.getSalesReturnByCustomerName(req.getParameter("custoName"));
					...
					case "salesReturnSearchByAgentName":
						page = "salesSearchReturn.jsp";
						List<SalesReturn> salesRetLstByA = ejb.getSalesReturnByAgentName(req.getParameter("agentName"));
					...
					case "salesReturnSearchByProductCode":
						...
						List<SalesReturn> salesRetLstByP = ejb
								.getSalesReturnByProductCode(req.getParameter("prodCode"));
					...
					case "salesProductView":
						...
						req.setAttribute("pId", req.getParameter("pId"));
						req.setAttribute("purEntryList",
								ejb.getSalesEntriesByProductId(Integer.parseInt(req.getParameter("pId"))));
					...
					case "addUOM":
						...
						if (flag == 0) {
							...
							qtyUnit.setQtyUnitType(
									ejb.getQtyUnitTypeById(Integer.parseInt(req.getParameter("qtyUnitTypeId"))));
					...
					case "addNewConversion":
						...
						if (Float.parseFloat(req.getParameter("convValue")) > 0) {
							if (req.getParameter("name1").equals("2")) {
								...
								qtyUnitConversion.setQtyUnitId1(
										ejb.getQtyUnitById(Integer.parseInt(req.getParameter("firstUnit"))));
								qtyUnitConversion.setQtyUnitId2(
										ejb.getQtyUnitById(Integer.parseInt(req.getParameter("selectedUnit"))));
					...
					case "goProView":
						...
						List<ProductDetail> amiProduct1 = ejb.getProductDetailsByCodeDescriptionCategory(
								req.getParameter("pCodeSearch").toUpperCase(),
								req.getParameter("pDesSearch").toUpperCase(),
								req.getParameter("pCatSearch").toUpperCase());
					...
					case "createNewUser":
						...
						if (uf == 0) {
							...
							securityAnswers.setSequrityQuestions(
									ejb.getSecurityQuestionById(Integer.parseInt(req.getParameter("sqId1"))));
							securityAnswers.setAnswer(req.getParameter("ans1").toUpperCase());
							...
							securityAnswers.setUsers(usr);
							securityAnswers.setSequrityQuestions(
									ejb.getSecurityQuestionById(Integer.parseInt(req.getParameter("sqId2"))));
							securityAnswers.setAnswer(req.getParameter("ans2").toUpperCase());
							ejb.setSecurityAns(securityAnswers);
							securityAnswers = null;
					...
					case "goSalesReturn":
						...
						List<SalesEntry> saleEntryListR = ejb.getSalesEntryDByChallanNo(
								req.getParameter("companyInitial") + "/" + req.getParameter("fynYear") + "/"
										+ req.getParameter("month") + "/" + req.getParameter("billType") + "/"
										+ req.getParameter("autoNum") + "/" + req.getParameter("suffix"));
						...
						if (saleEntryListR.size() > 0) {
							...
							msg = "Your search for Sales challan number : " + req.getParameter("companyInitial") + "/"
									+ req.getParameter("fynYear") + "/" + req.getParameter("month") + "/"
									+ req.getParameter("billType") + "/" + req.getParameter("autoNum") + "/"
									+ req.getParameter("suffix");
						} else {
					...
					case "salesReturnServlet":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "rQtySa", "salesProductDetailsID")) {
							req.setAttribute("msg", "Failed! Please try again!");
							req.getRequestDispatcher(page).forward(req, resp);
							return;
						}
						...
						if (chSR == 0) {
							...
							salesReturn.setChallanNo(Integer.parseInt(req.getParameter("challanNo")));
							salesReturn.setChallanSuffix(Integer.parseInt(req.getParameter("challanSuffix")));

							salesReturn.setSalesEntry(salesEntry);
							salesReturn.setChallanNumber(req.getParameter("challanNumber"));
							salesReturn.setRoundOff(Float.parseFloat(req.getParameter("roundvalue")));
							salesReturn.setReturnDate(DateConverter.getDate(req.getParameter("salesReturnDate")));
							salesReturn.setTotalReCost(Float.parseFloat(req.getParameter("grandtotal")));
							salesReturn.setReferenceSalesChallan(req.getParameter("saslesRChallanRId"));
							salesReturn.setRetAgentProfitTotal(Float.parseFloat(req.getParameter("profitValue")));
							salesReturn.setUsers(ejb.getUserById((String) httpSession.getAttribute("user")));
							ejb.setSalesReturn(salesReturn);

							paymentDetails = new PaymentDetails();
							paymentDetails.setPaidAmount(Float.parseFloat(req.getParameter("tbv")));
							paymentDetails.setTotalAmount(ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).get(0)
									.getTotalAmount()
									- ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).get(0).getPaidAmount());
							paymentDetails.setPaymentDate(DateConverter.getDate(req.getParameter("payDate")));
							paymentDetails.setDescription(req.getParameter("desc"));
							paymentDetails.setSalesReturn(salesReturn);
							paymentDetails.setSalesEntry(salesEntry);
							paymentDetails.setPaymentType(ejb.getPaymentTypeByType(req.getParameter("pType")));
							if (ejb.getPaymentDetailsBySalesEntryId(salesEntry.getId()).get(0).getTotalAmount() - ejb
									.getPaymentDetailsBySalesEntryId(salesEntry.getId()).get(0).getPaidAmount() > Float
							...
							voucherDetails.setVoucherAssign(
									ejb.getVoucherAssignByCustomerId(Integer.parseInt(req.getParameter("customerId"))));
								...
								if (!qty4[l].equals("0")) {
									if (!qty4[l].equals("")) {
										salesProductDetails = ejb
												.getSalesProductDetailsById(Integer.parseInt(salesProductDetailId[l]));
										salesProductDetails.setSalesReQty(
												salesProductDetails.getSalesReQty() + Float.parseFloat(qty4[l]));
										ejb.updateSalesProductDetails(salesProductDetails);

										salesProductReturnDetail = new SalesProductReturnDetail();
										salesProductReturnDetail.setSalesReturn(salesReturn);

										salesProductReturnDetail.setFault(p3[l]);
										salesProductReturnDetail.setQtyReturn(Float.parseFloat(qty4[l]));
										...
										companyInfo = ejb.getUserById((String) httpSession.getAttribute("user"))
												.getCompanyInfo();
										if (purchaseProductDetails.getProductDetail().isRaw()) {
											rawMaterialsStock = ejb.getRawMeterialStoctByProductAndCompanyId(
													purchaseProductDetails.getProductDetail().getId(),
											...
											readyGoodsStock.setRemainingQty(
													readyGoodsStock.getRemainingQty() + Float.parseFloat(qty4[l]));
							...
							// new to check
							if (salesEntry.getVendor() != null && salesEntry.isEfectiveProfit()) {
								uniqueNo = ejb.getLastUniqueNoOfPayDet4ViaAgent() + 1;

								voucherDetForViaAgent = new VoucherDetailsForViaAgents();
								voucherDetForViaAgent.setVoucherAssignId(
										ejb.getVoucherAssignByVendorId(salesEntry.getVendor().getId()).get(0).getId());
								voucherDetForViaAgent.setAgentId(salesEntry.getVendor().getId());
								voucherDetForViaAgent.setSalesEntryId(salesEntry.getId());
								voucherDetForViaAgent.setSalesReturnId(salesReturn.getId());
								voucherDetForViaAgent.setCredit(false);
								voucherDetForViaAgent.setValue(salesReturn.getRetAgentProfitTotal());
								voucherDetForViaAgent.setVoucherDate(salesReturn.getReturnDate());
								voucherDetForViaAgent.setEntryDate(new Date());
								voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
								ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);

								payDetForViaAgent = new PaymentDetailsForViaAgents();
								payDetForViaAgent.setPaymentDate(salesReturn.getReturnDate());
								payDetForViaAgent.setEntryDate(new Date());
								payDetForViaAgent.setPaidAmount(salesReturn.getRetAgentProfitTotal());
								payDetForViaAgent.setSalesEntryId(salesEntry.getId());
								payDetForViaAgent.setSalesReturnId(salesReturn.getId());
								payDetForViaAgent.setAgentId(salesEntry.getVendor().getId());
								payDetForViaAgent.setPaymentTypeId(ejb.getPaymentTypeByType("Credit Note").getId());
								payDetForViaAgent.setPaymentStatusId(ejb.getPaymentStatusByStatus("Semi Paid").getId());
								payDetForViaAgent.setUniqueNo(uniqueNo);
					...
					case "updateJob":
						...
						for (JobTypes jt : ejb.getAllJobTypes()) {
							if (jt.getJobName().equalsIgnoreCase(req.getParameter("name"))
									&& !jobTypes.getJobName().equalsIgnoreCase(req.getParameter("name"))) {
								flag = 1;
								break;
							}
						}
					...
					case "updateItems":
						page = "setupItem.jsp";
						itemDetails = ejb.getItemDetailsById(Integer.parseInt(req.getParameter("id")));
						flag = 0;
						for (ItemDetails jt : ejb.getAllItemDetails()) {
							if (jt.getName().equalsIgnoreCase(req.getParameter("name"))
									&& !itemDetails.getName().equalsIgnoreCase(req.getParameter("name"))) {
								flag = 1;
								break;
							}
						}
					...
					case "sampleJobCost":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "productId", "proQty", "rate", "amount", "qtyUnitId", "itemId",
								"jobId" + req.getParameter("productId"), "jobqty" + req.getParameter("productId"),
						...
						List<SampleDesignCostSheet> sampleDesignCostSheetLst = ejb.getAllSampleDesignCostSheet();
						int chD = 0;
						for (SampleDesignCostSheet pe : sampleDesignCostSheetLst) {
							if (pe.getDesignNumber().equals(req.getParameter("designNo").toUpperCase())) {
								chD = 1;
								break;
							}
						}
						if (chD == 0) {
							...
							sampleDesignCostSheet
									.setDesignDescription(req.getParameter("designDescription").toUpperCase());
							sampleDesignCostSheet.setDesignNumber(req.getParameter("designNo").toUpperCase());
							...
							sampleDesignCostSheet.setGrandTotal(Float.parseFloat(req.getParameter("grandtot")));
							sampleDesignCostSheet.setProfit(Float.parseFloat(req.getParameter("totProfit")));
							if (req.getParameter("profitType").equals("profitFlat")) {
							...
							for (int lc = 0; lc < productid.length; lc++) {
								...
								productsForDesignCostSheet
										.setQtyUnit(ejb.getQtyUnitById(Integer.parseInt(proqtyUnitId[lc])));
								...
								itmProductsForSample.setProductId(Integer.parseInt(productid[lc]));
								itmProductsForSample.setProductForDesignCostSheetId(productsForDesignCostSheet.getId());
								itmProductsForSample.setSampleId(sampleDesignCostSheet.getId());
								itmProductsForSample
										.setItemDetails(ejb.getItemDetailsById(Integer.parseInt(itemId[lc])));
								...
								for (int lc1 = 0; lc1 < jobid.length; lc1++) {
									...
									jobsForDesignCostSheet
											.setJobTypes(ejb.getJobTypeById(Integer.parseInt(jobid[lc1])));
									...
									jobsForDesignCostSheet
											...
											.setVendor(ejb
													.getVendorById(Integer.parseInt(req.getParameter("designerId"))));
					...
					case "jobAssignmentForParticularDesignNumber":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "productForSampleId",
								"jobIdH" + req.getParameter("productForSampleId"),
								"jobQtyH" + req.getParameter("productForSampleId"),
								"purProDetId" + req.getParameter("productForSampleId"),
								"qtySelected" + req.getParameter("productForSampleId"), "productForSampleId1",
								"productId1", "qtyOfSampleProduct", "productEachTotal",
								"purProDetId" + req.getParameter("productForSampleId1"),
								"jobId" + req.getParameter("productForSampleId1"),
								"jobQty" + req.getParameter("productForSampleId1"),
								"jobPresentRate" + req.getParameter("productForSampleId1"),
								"jobAmount" + req.getParameter("productForSampleId1"),
								"estSubmDate" + req.getParameter("productForSampleId1"))) {
							req.setAttribute("msg", "Failed! Please try again!");
							req.getRequestDispatcher(page).forward(req, resp);
							return;
						}
						...
						sampleDesignCostSheet = ejb
								.getSampleDesignCostSheetById(Integer.parseInt(req.getParameter("dId")));

						List<JobAssignmentDetails> jobAssgn = ejb.getAllJobassignmentDetails();
						int chJ = 0;
						for (JobAssignmentDetails pe : jobAssgn) {
							if (pe.getChallanNumber().equals(req.getParameter("jobChallanNo"))) {
								chJ = 1;
								break;
							}
						}
						if (chJ == 0) {
							...
							for (int l = 0; l < productForSampleId.length; l++) {
								...
								String[] jobForSampleIdH = req.getParameterValues("jobIdH" + productForSampleId[l]);
								String[] jobQtyH = req.getParameterValues("jobQtyH" + productForSampleId[l]);
								for (int l1 = 0; l1 < jobForSampleIdH.length; l1++) {
									...
									jobPlanJobStock.setJobsForDesignCostSheet(
											ejb.getJobsForDesignCostSheetById(Integer.parseInt(jobForSampleIdH[l1])));
								...
								for (int l1 = 0; l1 < purProDetId.length; l1++) {
									purchaseProductDetails = ejb
											.getPurchaseProductDetailsById(Integer.parseInt(purProDetId[l1]));
									...
									jobPlanProductStock
											.setProductsForDesignCostSheet(ejb.getProductsForDesignCostSheetById(
													Integer.parseInt(productForSampleId[l])));
									...
									jobPlanProductStock.setCost(purchaseProductDetails.getCost());
									...
									if (purchaseProductDetails.getProductDetail().isRaw()) {
										rawMaterialsStock = ejb.getRawMeterialStoctByProductId(
												purchaseProductDetails.getProductDetail().getId());
										rawMaterialsStock.setRemainingQty(rawMaterialsStock.getRemainingQty()
												- Float.parseFloat(qtySelected[l1]));
										ejb.updateRawMaterialStockDetail(rawMaterialsStock);
									} else {
										readyGoodsStock = ejb.getReadyGoodsStoctByProductId(
												purchaseProductDetails.getProductDetail().getId());
										readyGoodsStock.setRemainingQty(
							...
							jobAssignmentDetails
									.setVendor(ejb.getVendorById(Integer.parseInt(req.getParameter("jName"))));
							...
							for (int l1 = 0; l1 < productForSampleId1.length; l1++) {
								...
								jobAssignmentProducts.setProductsForDesignCostSheet(ejb
										.getProductsForDesignCostSheetById(Integer.parseInt(productForSampleId1[l1])));
								ejb.setJobAssignmentProducts(jobAssignmentProducts);
								...
								for (int l2 = 0; l2 < purProDetId1.length; l2++) {
									jobPlanProductStock = ejb
											.getJobPlanProductStockByPurchaseProductDetailsIdAndJobPlanId(
													Integer.parseInt(purProDetId1[l2]), jobPlan.getId());
								...
								for (int lc1 = 0; lc1 < jobid.length; lc1++) {
									...
									jobAssignmentJobDetails
											.setEstimatedCompletionDate(DateConverter.getDate(estSubmDate[lc1]));
									jobAssignmentJobDetails.setQtyUnit(
											ejb.getProductDetailById(Integer.parseInt(prodId[l1])).getQtyUnit());
									jobAssignmentJobDetails.setJobType(ejb
											.getJobsForDesignCostSheetById(Integer.parseInt(jobid[lc1])).getJobTypes());
							...
							jobPlan.setTotalExpanse(jobPlan.getTotalExpanse() + totalJobExpanse);
							ejb.updateJobPlan(jobPlan);
							req.setAttribute("jobAssignId", jobAssignmentDetails.getId());
					...
					case "jobAssignmentForOngoingJobs":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "productForSampleId1", "productId1", "qtyOfSampleProduct",
								"productEachTotal", "jobId" + req.getParameter("productForSampleId1"),
								"jobQty" + req.getParameter("productForSampleId1"),
								"jobPresentRate" + req.getParameter("productForSampleId1"),
								"jobAmount" + req.getParameter("productForSampleId1"),
								"estSubmDate" + req.getParameter("productForSampleId1"))) {
						...
						jobPlan = ejb.getJobPlanById(Integer.parseInt(req.getParameter("planNo")));

						List<JobAssignmentDetails> jobAssgn1 = ejb.getAllJobassignmentDetails();
						int chJ1 = 0;
						...
						if (chJ1 == 0) {
							...
							String[] productForSampleId2 = req.getParameterValues("productForSampleId1");
							String[] prodId2 = req.getParameterValues("productId1");
							String[] qtyOfSampleProduct2 = req.getParameterValues("qtyOfSampleProduct");
							String[] productEachTotal2 = req.getParameterValues("productEachTotal");
							...
							for (int l1 = 0; l1 < productForSampleId2.length; l1++) {
								...
								jobAssignmentProducts = new JobAssignmentProducts();
								jobAssignmentProducts.setJobAssignmentDetails(jobAssignmentDetails);
								jobAssignmentProducts.setQty(Float.parseFloat(qtyOfSampleProduct2[l1]));
								...
								jobAssignmentProducts.setJobPlanProducts(jobPlanProducts);
								jobAssignmentProducts.setProductsForDesignCostSheet(ejb
										.getProductsForDesignCostSheetById(Integer.parseInt(productForSampleId2[l1])));
								ejb.setJobAssignmentProducts(jobAssignmentProducts);

								for (int l2 = 0; l2 < ejb
										.getJobPlanProductStockBySampleProductIdAndPlanId(
												Integer.parseInt(productForSampleId2[l1]), jobPlan.getId())
										.size(); l2++) {
									jobPlanProductStock = ejb.getJobPlanProductStockBySampleProductIdAndPlanId(
											Integer.parseInt(productForSampleId2[l1]), jobPlan.getId()).get(l2);
									jobPlanProductStock.setJobAssignmentProducts(jobAssignmentProducts);
									ejb.updateJobPlanProductStock(jobPlanProductStock);
								}

								String[] jobid = req.getParameterValues("jobId" + productForSampleId2[l1]);
								String[] jobqty = req.getParameterValues("jobQty" + productForSampleId2[l1]);
								String[] jobrate = req.getParameterValues("jobPresentRate" + productForSampleId2[l1]);
								String[] jobamount = req.getParameterValues("jobAmount" + productForSampleId2[l1]);
								String[] estSubmDate = req.getParameterValues("estSubmDate" + productForSampleId2[l1]);
								float totalJobCost = 0;
								...
								for (int lc1 = 0; lc1 < jobid.length; lc1++) {
									...
									jobAssignmentJobDetails
											.setEstimatedCompletionDate(DateConverter.getDate(estSubmDate[lc1]));
									jobAssignmentJobDetails.setQtyUnit(
											ejb.getProductDetailById(Integer.parseInt(prodId2[l1])).getQtyUnit());
									jobAssignmentJobDetails.setJobType(ejb
											.getJobsForDesignCostSheetById(Integer.parseInt(jobid[lc1])).getJobTypes());
									jobAssignmentJobDetails.setJobAssignmentDetails(jobAssignmentDetails);
									jobAssignmentJobDetails.setAssignmentProducts(jobAssignmentProducts);
							...
							jobPlan.setTotalJobExpanse(totalJobExpanse1 + jobPlan.getTotalJobExpanse());
							jobPlan.setTotalExpanse(jobPlan.getTotalExpanse() + totalJobExpanse1);
							ejb.updateJobPlan(jobPlan);
					...
					case "jobRecieve":
						...
						// ////////Null Manage////////////////////////////
						if (verifyParams(req, resp, "jobPlanProductsId", "jobAssgnProductsId", "prodQtyRe")) {
							req.setAttribute("msg", "Failed! Please try again!");
							req.getRequestDispatcher(page).forward(req, resp);
							return;
						}
						...
						jobAssignmentDetails = ejb
								.getJobAssignmentDetailsByID(Integer.parseInt(req.getParameter("jobAssignID")));
						dt = new Date();

						List<JobRecievedDetails> jobRec = ejb.getAllJobRecievedDetails();
						int chJR = 0;
						for (JobRecievedDetails pe : jobRec) {
							if (pe.getChallanNumber().equals(req.getParameter("jobReChallanNo"))) {
								chJR = 1;
								break;
							}
						}
						if (chJR == 0) {
							...
							jobRecievedDetails.setReferenceJobAssignChallan(req.getParameter("jobChallanNo"));
							jobRecievedDetails.setJobAssignmentDetails(jobAssignmentDetails);
							jobRecievedDetails.setChallanNumber(req.getParameter("jobReChallanNo"));
							jobRecievedDetails.setChallanNo(Integer.parseInt(req.getParameter("challanNo")));
							jobRecievedDetails.setChallanSuffix(Integer.parseInt(req.getParameter("challanSuffix")));
							ejb.setJobRecieve(jobRecievedDetails);

							String jobPlanProductsId[] = req.getParameterValues("jobPlanProductsId");
							String jobAssgnProductsId[] = req.getParameterValues("jobAssgnProductsId");
							...
							for (int l = 0; l < jobPlanProductsId.length; l++) {
								...
								jobRecieveProductsDetails.setQtyReturn(Float.parseFloat(prodQtyRe[l]));
								jobRecieveProductsDetails.setJobRecievedDetails(jobRecievedDetails);
								jobRecieveProductsDetails.setJobPlanProducts(
										ejb.getJobPlanProductsById(Integer.parseInt(jobPlanProductsId[l])));
								ejb.setJobRecieveProductsDetails(jobRecieveProductsDetails);

								jobPlanProducts = ejb.getJobPlanProductsById(Integer.parseInt(jobPlanProductsId[l]));
								jobPlanProducts.setRemainingQty(
										jobPlanProducts.getRemainingQty() + Float.parseFloat(prodQtyRe[l]));
								if (jobPlanProducts.getQty() == jobPlanProducts.getRemainingQty()) {
									jobPlanProducts.setUndergoingProcess(false);
								}
								jobPlanProducts.setJobCycle(jobPlanProducts.getJobCycle() + 1);
								ejb.updateJobPlanProducts(jobPlanProducts);

								jobAssignmentProducts = ejb
										.getJobAssignmentProductsByJobPlanProductIdAndJobAssignmentId(
												Integer.parseInt(jobPlanProductsId[l]), jobAssignmentDetails.getId());
								jobAssignmentProducts.setRemaninQty(
										jobAssignmentProducts.getRemaninQty() - Float.parseFloat(prodQtyRe[l]));
								ejb.updateJobAssignmentProductDetails(jobAssignmentProducts);

								String[] jobAssgnJobId = req
										.getParameterValues("jobAssgnJobId" + jobAssgnProductsId[l]);
								String qtyRe[] = req.getParameterValues("qtyRe" + jobAssgnProductsId[l]);
								for (int lc1 = 0; lc1 < jobAssgnJobId.length; lc1++) {
									if (!qtyRe[lc1].equals("0")) {
										...
										jobReceiveJobDetails.setJobPlanJobStock(jobPlanJobStock);
										jobReceiveJobDetails.setJobRecieveProductsDetails(jobRecieveProductsDetails);
										jobReceiveJobDetails.setQtyDone(Float.parseFloat(qtyRe[lc1]));
					...
					case "dayBookreport":
						...
						List<Purchase_Entry> purchaseEty = ejb.getPurchaseEntryByDateForReport(
								DateConverter.getDate(req.getParameter("dayBookDate")));
						List<SalesEntry> salesEty = ejb
								.getSalesEntryByDateForReport(DateConverter.getDate(req.getParameter("dayBookDate")));
						List<PurchaseReturn> purchaseReturn = ejb.getPurchaseReturnByDateForReport(
								DateConverter.getDate(req.getParameter("dayBookDate")));
						List<SalesReturn> salesReturn = ejb
								.getSalesReturnByDateForReport(DateConverter.getDate(req.getParameter("dayBookDate")));
					...
					case "creditNoteByVendorName":
						...
						List<VoucherDetails> voucherDetailsV = ejb
								.getDecendingVoucherDetailsByVendorId(Integer.parseInt(req.getParameter("vId")));
					...
					case "creditNoteByAgentName":
						...
						List<VoucherDetails> voucherDetailsPA = ejb
								.getDecendingVoucherDetailsByVendorId(Integer.parseInt(req.getParameter("paId")));
					...
					case "creditNoteByViaPurchaseAgentName":
						...
						List<VoucherDetailsForViaAgents> voucherDetailsVPA = ejb
								.getVoucherDetails4ViaAgentByAgentIdDesc(Integer.parseInt(req.getParameter("paId")));
					...
					case "creditNoteBySalesAgentName":
						...
						List<VoucherDetailsForViaAgents> voucherDetailsForVA = ejb
								.getVoucherDetails4ViaAgentByAgentIdDesc(Integer.parseInt(req.getParameter("saId")));
					...
					case "creditNoteByJobber":
						...
						List<VoucherDetails> voucherDetailsJ = ejb
								.getDecendingVoucherDetailsByVendorId(Integer.parseInt(req.getParameter("jId")));
					...
					case "debitNoteByCustomer":
						...
						List<VoucherDetails> voucherDetailsC = ejb
								.getDescendingVoucherDetailsbyCustomerId(Integer.parseInt(req.getParameter("cId")));
	...
	public boolean verifyParams(HttpServletRequest req, HttpServletResponse resp, String... params)
