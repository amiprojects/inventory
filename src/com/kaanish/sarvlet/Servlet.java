			...
			if (!GetMacId.getSerialNumberOfKaanishExternalHDD(
				...
				try {
					...
					case "updateCompanyInfo":
						...
						if (req.getParameter("isPurchaseAgentShow").equals("yes")) {
					...
					case "salesAgentPayment":
						...
						if (isDuplicateSAP) {
							...
							voucherDetForViaAgent.setVoucherDate(DateConverter.getDate(req.getParameter("payDate")));
							voucherDetForViaAgent.setEntryDate(new Date());
							voucherDetForViaAgent.setUserId((String) httpSession.getAttribute("user"));
							ejb.setVoucherDetails4ViaAgent(voucherDetForViaAgent);
					...
					case "jobSearchByDesignNo":
						...
						List<JobAssignmentDetails> jobAssignListByDN = ejb
								.getJobAssignByDesignNumber(req.getParameter("dNo"));
						req.setAttribute("jobAssignList", jobAssignListByDN);
						if (jobAssignListByDN.size() > 0) {
							msg = "Your search for Design No : " + req.getParameter("dNo").toUpperCase();
						} else {
							msg = "No result found for Design No : " + req.getParameter("dNo").toUpperCase();
						}
						break;
					...
					case "goStockView":
						...
						if (!req.getParameter("pCodeSearch").equals("")) {
							...
							req.setAttribute("searchVal", req.getParameter("pCodeSearch"));
						} else if (!req.getParameter("pDesSearch").equals("")) {
							req.setAttribute("searchBy", "Product description");
							req.setAttribute("searchVal", req.getParameter("pDesSearch"));
						} else if (!req.getParameter("pCatSearch").equals("")) {
							req.setAttribute("searchBy", "Category");
							req.setAttribute("searchVal", req.getParameter("pCatSearch"));
						}
