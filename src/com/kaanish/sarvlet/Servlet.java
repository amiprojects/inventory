...
@WebServlet({ "/logout", "/addTax", "/addTaxGroup", "/editTax", "/deleteTax", "/editTaxGroup", "/deleteTaxGroup",
		...
		"/salesSearchByProductCode", "/salesView", "/purchaseBarCode", "/salesReturnServlet" })
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			case "purchaseSearchByVendorName":
				page = "purchasingPurchaseSearch.jsp";
				List<Purchase_Entry> purEntryList2 = ejb.getPurchaseEntryByVendorName(req.getParameter("vendorName"));
			...
			case "purchaseSearchByAgentName":
				page = "purchasingPurchaseSearch.jsp";
				List<Purchase_Entry> purEntryList3 = ejb.getPurchaseEntryByAgentName(req.getParameter("agentName"));
			...
			case "purchaseSearchByProductCode":
				page = "purchasingPurchaseSearch.jsp";
				List<Purchase_Entry> purEntryList4 = ejb.getPurchaseEntryByProductCode(req.getParameter("prodCode"));
			...
			case "jChallanSearch":
				...
				jobAssignmentDetails = ejb.getJobAssignmentDetailsbyChallanNumber(req.getParameter("jChallan"));
