...
@WebServlet({ "/logout", "/addTax", "/addTaxGroup", "/editTax", "/deleteTax", "/editTaxGroup", "/deleteTaxGroup",
		...
		"/jobAssignmentForParticularDesignNumber", "/purchaseOrderEntry", "/purchaseSearchForPORecieve",
		"/purchaseOrderReceive", "/jobAssignmentForOngoingJobs", "/sampleJobSearchAll", "/sampleJobSearchByDesignNo",
		"/sampleJobSearchByDesignerName", "/sampleJobCostSheetView", "/jobSearchByPlanNo", "/purchaseEdit",
		"/jobReceiveFromSearch", "/setItems", "/updateItems", "/completePlanAndProductSumaryProduction",
		"/purchaseProductionView", "/purchaseProductionSearchAll", "/purchaseProductionSearchByDate",
		"/purchaseProductionSearchByPurchaseChallanNo", "/purchaseProductionSearchByProductCode" })
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			case "salesProductView":
				...
				req.setAttribute("pId", req.getParameter("pId"));
				req.setAttribute("purEntryList", ejb.getSalesEntriesByProductCode(req.getParameter("prodCode")));
					...
					for (int l = 0; l < p3.length; l++) {
						if (!qty4[l].equals("0")) {
							if (!qty4[l].equals("")) {
								...
								salesProductDetails
										.setSalesReQty(salesProductDetails.getSalesReQty() + Integer.parseInt(qty4[l]));
			...
			case "sampleJobCost":
				...
				for (SampleDesignCostSheet pe : sampleDesignCostSheetLst) {
					if (pe.getDesignNumber().equals(req.getParameter("designNo"))) {
						chD = 1;
						break;
					}
				}
