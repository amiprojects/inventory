...
@WebServlet({ "/login", "/logout", "/addTax", "/addTaxGroup", "/editTax", "/deleteTax", "/editTaxGroup",
		...
		"/deleteProductImage", "/jobAssignment", "/jobAssignSearchByDate", "/salesEntry", "/createUserGroup","/updateUserGroup","/updateUser" })
		...
		try {
			...
			case "createNewUser":
				...
				for(Users u:ejb.getAllUsers()){
					if(u.getPh().equals(req.getParameter("mobile"))||u.getUserId().equals(req.getParameter("userId"))){
						uf=1;
					}
				}
