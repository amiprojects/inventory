...
public class Ejb {
	...
	public List<Purchase_Product_Details> getPurchase_Product_DetailsByProId(int id) {
		TypedQuery<Purchase_Product_Details> q = em.createQuery("select s from Purchase_Product_Details s where s.productDetail.id=:Id",
	...
	public List<ProductDetail> getProductDetailBydescription(String name) {
		TypedQuery<ProductDetail> q = em.createQuery("select c from ProductDetail c where UPPER(c.description) like :nm", ProductDetail.class);
		q.setParameter("nm", "%" + name.toUpperCase() + "%");
		return q.getResultList();
	}
/********************for product Image************************/
	...
	public List<ProductImage> getAllProductImageByProductId(int id){
		TypedQuery<ProductImage> q=em.createQuery("select s from ProductImage s where s.productDetail.id=:id", ProductImage.class);
		q.setParameter("id", id);
		return q.getResultList();
	}
	/********************** for serial number ********************/
