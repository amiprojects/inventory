	...
	public List<Notification> getNotifications() {
			...
			if (pe.getPurchase_date().before(
				...
				for (Purchase_Product_Details ppd : pe.getPurchase_Product_Details()) {
					if (ppd.getRemaining_quantity() > 0) {
						...
						n.setDescription(qt + ppd.getProductDetail().getQtyUnit().getName()
								+ " quantity of product code " + ppd.getProductDetail().getCode() + " of lot number "
								+ ppd.getLotNumber() + " is in stock more than " + days + " days.");
		...
		for (SalesEntry se : getAllSalesEntries()) {
			...
			if (se.getSales_date()
				...
				n.setDescription("Purchase payment due for purchase challan number " + se.getChallanNumber()
						+ " and ammount is " + (pd.getTotalAmount() - pd.getPaidAmount()) + " for " + days + " days.");
