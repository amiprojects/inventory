			...
			<div class="content-sec"
				...
				<div class="container">
					<div class="row">
						...
						<!-- Choose -->			<div style="width:40%; float:left; border:1px solid;height:262px;">	
													<div align="left" >	<center><input type="file" name="proImg" size="20"
												onchange="readURL(this);"> </center></div> 
												</div>
												
												<div style="width:20%; float:left;"> </div>
												
											<!-- Sanp --><div style="width:40%; float:right;border:1px solid;">	
											<div align="right" ><center><a href="javascript:void(take_snapshot())">Take Snapshot</a></center>
