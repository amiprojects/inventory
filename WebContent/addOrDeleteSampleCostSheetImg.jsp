					...
					<div class="row">
						<div class="masonary-grids">
							...
							<div class="breadcrumbs"
								...
								<h3 style="margin-top: 11px;">Upload or Delete Image</h3>
							</div>

							<div class="widget-area">
								<div class="col-md-12">
									<div align="center">
										<form action="uploadSampleCostSheetImage"
										...
										<div
											...
											<div
												...
												<c:forEach
													items="${sessionScope['ejb'].getAllDesignImageBySampleJobId(param.id)}"
													var="img">
													<div style="float: left;">
														...
														<c:if
															test="${sessionScope['ejb'].getAllDesignImageBySampleJobId(param.id).size()>1}">
															<a
																href="deleteSampleCostSheetImage?imageId=${img.id}&id=${param.id}">delete
																Image</a>
														</c:if>
													</div>
												</c:forEach>
										...
										<div align="right">
											<form action="sampleJobCostSheetView" method="post"
												id="JobDetails${param.id}">
												<a href="#" onclick="jobShowDetails('${param.id}');"><input
													type="hidden" value="${param.id}"
													name="sampleDesignCostSheetId">
												<button class="btn blue btn-default" type="button">Back</button></a>
											</form>
										</div>
									</div>
