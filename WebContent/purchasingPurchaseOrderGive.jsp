									...
									<div class="widget-area">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<c:set var="cno"
													value="${sessionScope['ejb'].getLastPurchaseOrderChallanNumberByCompany(compInfo.id)+1}" />
												<c:set var="csuf"
													value="${sessionScope['ejb'].getLastPurchaseOrderChallanSuffixByCompany(compInfo.id)+1}" />
												<c:set var="suf" value="PURO" />
												<c:set var="bs"
