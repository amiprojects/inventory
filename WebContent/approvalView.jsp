...
<body>
	...
	<c:set var="approvalSearchView"
		value="${sessionScope['ejb'].getApprovalEntryById(requestScope['id'])}"></c:set>
				...
				<div class="row">
					<div class="masonary-grids">
						...
						<div class="breadcrumbs" style="height: 50px; text-align: center;">
							<h3 style="margin-top: 11px;">Approval View</h3>
						</div>
						...
						<div class="col-md-12" style="height: 800px;">
										...
										<table cellspacing="2">
											<tr>
												...
												<td><input type="text" name="custName" id="custName"
													...
													value="${approvalSearchView.customer.name}"></input></td>
											</tr>
											...
											<tr>
												...
												<td><input type="text" name="addr" id="addr"
													...
													readonly="readonly"
													value="${approvalSearchView.customer.address}"></input></td>
											</tr>
											<tr>
												<td>City :</td>
												<td><input type="text" name="city" id="city"
													style="length: 40px;" readonly="readonly"
													value="${approvalSearchView.customer.city}"></input></td>
											</tr>
											...
											<tr>
												...
												<td><input type="number" name="phone" id="phone"
													style="length: 40px;" readonly="readonly"
													value="${approvalSearchView.customer.mobile}"></input></td>
											</tr>
											...
											<tr>
												...
												<td><input type="text" name="vatcst" id="vatcst"
													style="length: 40px;" readonly="readonly"
													value="${approvalSearchView.customer.vat_cst_no}"></input></td>
											</tr>
											<tr>
												<td><c:choose>
														<c:when test="${approvalSearchView.vendor!=null}">
												...
												<td><input type="text" name="agentName" id="agentName"
													style="length: 40px;" readonly="readonly"
													value="${approvalSearchView.vendor.name}"></input></td>
											</tr>
											<tr id="aDetailsDiv">
												<td>Agent details :</td>
												<td><textarea rows="" cols="" id="aDetail"
														...
														style="width: 100%;">
														Address : 
															&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;${approvalSearchView.vendor.address}
															Ph1 : ${approvalSearchView.vendor.ph1}
															Ph2 : ${approvalSearchView.vendor.ph2}
														</textarea></td>
											</tr>
										</table>
									</div>
									...
									<div class="widget-area"
										...
										<div class="form-group" style="padding-top: 18px;">
											<label style="font-size: 15px" class="font">Approval
												...
												value="${approvalSearchView.challanNumber}">
										</div>
										...
										<div class="form-group">
											<label style="font-size: 15px" class="font">Date :</label> <input
												...
												value='<fmt:formatDate value="${approvalSearchView.approvalDate}" pattern="dd-MM-yyyy"/>'>
							...
							<div class="widget-area" style="padding: 3px 3px;">
								...
								<c:choose>
									<c:when test="${approvalSearchView.isMRP()==true}">
							...
							<div class="widget-area">
								<table class="table table-striped table-bordered"
									...
									<c:forEach var="approvalProducts"
										items="${approvalSearchView.approvalProductDetails}">
										<tbody>
											<tr>
												<td>${i}</td>
												<td>${approvalProducts.purchase_Product_Details.productDetail.code}</td>
												<td>${approvalProducts.purchase_Product_Details.productDetail.description}</td>
												<td>${approvalProducts.purchase_Product_Details.lotNumber}</td>
												<td>${approvalProducts.approvalRetQty}</td>
												<td>${approvalProducts.quantity}</td>
												<c:choose>
													<c:when test="${approvalSearchView.isMRP()==true}">
														<td>${approvalProducts.price}</td>
														<td><fmt:formatNumber var="amount"
																value="${approvalProducts.quantity*approvalProducts.price}"
								...
								<%-- <table class="table table-striped table-bordered" id="example"
									...
									<c:forEach var="approvalReturn"
										items="${approvalSearchView.approvalReturn}">

										<tbody>
											<tr>
												<td>${j}</td>
												<td><fmt:formatDate
														value="${approvalReturn.returnDate}" pattern="dd-MM-yy" /></td>
												<td><a href="#"
								...
								<div class="widget-area"
									...
									<div class="form-group"">
										...
										<textarea rows="6" cols="" class="form-control"
											...
											readonly="readonly">
											${approvalSearchView.description}
											</textarea>
									</div>
								</div>
							</div>
								...
								<table id="stream_table"
									...
									<thead>
										<tr>
											...
											<td><input type="number" class="form-control"
												...
												value="${approvalSearchView.subTotal}"></td>
										</tr>
									</thead>
										...
										<tr>
											<td colspan="2">Discount &nbsp; <select name="disType"
												id="disType" disabled="disabled">
													<c:choose>
														<c:when
															test="${approvalSearchView.isFlatDiscount()==true}">
															<option value="disFlat">Flat</option>
															<c:set var="dis"
																value="${approvalSearchView.discountValue}"></c:set>
														</c:when>
														<c:otherwise>
															<option value="disPer">%</option>
															<c:set var="dis"
																value="${approvalSearchView.subTotal*approvalSearchView.discountValue/100}"></c:set>
														</c:otherwise>
													</c:choose>
											</select>
											</td>
											<td><input type="number" class="form-control"
												...
												readonly="readonly"
												value="<fmt:formatNumber value="${approvalSearchView.discountValue}" maxFractionDigits="2" groupingUsed="false" />"></td>
										</tr>
									</tbody>
												...
												<tr>
													...
													<td>Is Effective On Return:&nbsp; <select
														name="isEffective" id="isEffective" disabled="disabled">
															<c:choose>
																<c:when
																	test="${approvalSearchView.isEfectiveProfit()==true}">
																	<option>Yes</option>
																</c:when>
																<c:otherwise>
																	<option>No</option>
												...
												<tr>
													<td colspan="2">Agent Profit: &nbsp; <select
														...
														onchange="profitTypeF();" disabled="disabled">
															<c:choose>
																<c:when
																	test="${approvalSearchView.isFlatProfitAgent()==true}">
													...
													<td><input type="text"
														value="${approvalSearchView.agentProfitValue}"
											...
											<tbody style="display: none;">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${approvalSearchView.agentProfitTotal}"></td>
												</tr>
											</tbody>
										</c:when>
										<c:otherwise>
										...
										<tr>
											<td><select class="form-control" id="taxGroup"
												name="taxGroup" disabled="disabled">
													<option>${approvalSearchView.tax_Type_Group.name}</option>
											</select></td>
											<td>%</td>
											<td><input type="text" class="form-control"
												readonly="readonly"
												value="${approvalSearchView.tax_Type_Group.getTotalTaxValue()}"
												id="taxTot"></td>
										</tr>
									</tbody>
									<tbody style="display: none;">
										<tr>
											...
											<td><input type="text" class="form-control"
												readonly="readonly" value="${approvalSearchView.taxAmount}"
												id="taxAmount"></td>
										</tr>
									</tbody>
									<tbody style="display: none;">
										<tr>
											...
											<td><input type="number" class="form-control"
												value="${approvalSearchView.transportcCharge}"
												id="transcharge" name="transcharge" readonly="readonly"></td>
										</tr>
									</tbody>
									...
									<tbody style="display: none;">
										<tr>
											...
											<td><input type="number" class="form-control"
												value="${approvalSearchView.surcharge}" id="surcharge"
									...
									<tbody>
										<tr>
											...
											<td><input type="number" class="form-control"
												...
												name="roundvalue" value="${approvalSearchView.roundOf}"></td>
										</tr>
									</tbody>
									<thead>
										<tr>
											...
											<td><input type="number" class="form-control"
												...
												name="grandtotal" value="${approvalSearchView.totalCost}"></td>
										</tr>
									</thead>
								</table>
								<br>
								<table>
									<tr>
										<td><input type="button" style="margin-left: 15px;"
											class="btn btn-primary large" value="Print Approval Bill"
											onclick="viewInvoice(${approvalSearchView.id});"></td>
									</tr>
								</table>
								<br>
							</div>
	...
	<form role="form" class="sec" method="post" id="paymentForm"
		...
		<input type="hidden" id="cId" name="cId"
			value="${approvalSearchView.customer.id}"> <input
			type="hidden" id="seId" name="seId" value="${approvalSearchView.id}"><input
			type="hidden" id="voucherDetailSize" name="voucherDetailSize"
			value="${sessionScope['ejb'].getAllVoucherDetailsBySalesEntryId(approvalSearchView.id)}">
	</form>
	<!-- Script -->
	...
	function viewInvoiceS(id){		
		window
		.open(
				"approvalReturnInvoiceForPrint.jsp?id="+id,
	...
	function payButtonOCF(){
		...
		/* $.ajax({
			...
			dataType : "json",
			data : {
				id : "${approvalSearchView.customer.id}"
			},
