															...
															<form action="#" method="get">
																...
																<div class="col-md-6">
																	<label for="exampleInputEmail1">Company Mobile
																		...
																		name="mono" placeholder="Eg. +9900000000"
																...
																<div class="col-md-6">
																	<div>
																		<label for="exampleInputPassword1">Company
																			Phone No:</label> <input type='tel' pattern="[0-9]{10,10}"
													...
													<div class="wizard-form-h">
														...
														<div id="step-1">
															...
															<form action="#" method="get">
																...
																<div class="col-md-6">
																	<div>
																		<label for="exampleInputEmail1">Service Tax
																			No:</label> <input type="number" name="servicet"
																			placeholder="Enter Company Name" required
																			class="form-control"><br>
																	</div>
																</div>
