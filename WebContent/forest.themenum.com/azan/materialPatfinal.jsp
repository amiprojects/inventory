...
<fieldset><legend><img src="Capture.PNG">&nbsp &nbsp Track  </legend>

<p style="font-size: 14px">(You want to track the product/raw materials by)</p><br><br><br>
<table class="table">
						...
						<div id="step3"
							...
							<fieldset>
								...
								<p style="font-size: 14px">(Enter the part's initial inventory.)</p>
								<br>
								<br>
								<br> <input type="radio" name="do" value="doNotAdd">Do
								not add initial inventory <br>
								<hr width="100%">
								...
								<div class="col-md-6">
									<div>
										<label for="exampleInputEmail1">UOM:</label><select name="uom" style="width: 238px; height: 34px">
         ...
         <table cellspacing="0" cellpadding="1"  width="300" >
           ...
           <tr>
             ...
             <td>789456123</td>
								...
								<a href="#">	<img src="img/pus.PNG" style="top: 2px; left: 3px"></a>
								<a href="#"> <img src="img/sp.PNG" style="top: 2px; left: 3px"> </a>
								<a href="#"><img src="img/hash.PNG" style="top: 2px; left: 3px"> </a>
								<a href="#"><img src="img/delete.PNG" style="top: 2px; left: 3px"></a>
								</div>
