	...
	<div class="login-sec">
		<div class="login">
			<div class="login-form">
				<form action="restore" id="restoreForm" method="post"
				...
				<form action="backup" id="backupForm" method="post">
					<button type="button" class="btn green pull-right"
						style="width: 100%; margin-bottom: 25px;" onclick="backupOCF();">
						<b>Backup</b>
					</button>
				</form>
				<h2 style="color: white;">${requestScope['msg']}</h2>
				<h3 style="color: white;">${requestScope['msgdet']}</h3>
			</div>
		</div>
	</div>
</body>
