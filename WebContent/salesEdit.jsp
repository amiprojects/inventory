										...
										<table cellspacing="2">
											...
											<tr>
												...
												<td><input type="text" name="agentName" id="agentName"
													...
													value="${salesSearchView.vendor.id}">
									...
									<c:forEach var="salesProducts"
										...
										<tbody id="trRemove${salesProducts.id}">
											<tr>
												...
												<td>
													<%-- <c:if test="${salesProducts.salesReQty==0}"> --%> <input
													type="text" value="${salesProducts.salesPrice}"
													style="background-color: gray;" readonly="readonly"
													name="mrpQty"
													onchange="qtyvalueF(this,${salesProducts.id});"
													ondblclick="enable(this);"> <%-- </c:if> <c:if test="${salesProducts.salesReQty!=0}">
